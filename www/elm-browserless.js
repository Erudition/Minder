											...
											return function (defaultRelevanceEnds) {
												return function (importance) {
													return function (extra) {
														return {activity: activity, completionUnits: completionUnits, defaultExternalDeadline: defaultExternalDeadline, defaultFinishBy: defaultFinishBy, defaultRelevanceEnds: defaultRelevanceEnds, defaultRelevanceStarts: defaultRelevanceStarts, defaultStartBy: defaultStartBy, extra: extra, id: id, importance: importance, maxEffort: maxEffort, minEffort: minEffort, predictedEffort: predictedEffort, title: title};
													};
												};
											};
										};
...
var $author$project$Task$Class$decodeRelativeTiming = A2($zwilias$json_decode_exploration$Json$Decode$Exploration$map, $author$project$Task$Class$FromDeadline, $author$project$Helpers$decodeDuration);
...
var $author$project$Task$Class$decodeClass = A4(
...
var $author$project$Replicated$Serialize$decodeFromJson = F2(
	function (codec, json) {
		var decoder = A2(
			$elm$json$Json$Decode$andThen,
			function (value) {
				return (value <= 0) ? $elm$json$Json$Decode$succeed(
					$elm$core$Result$Err($author$project$Replicated$Serialize$DataCorrupted)) : (_Utils_eq(value, $author$project$Replicated$Serialize$version) ? A2(
					$elm$json$Json$Decode$index,
					1,
					$author$project$Replicated$Serialize$getJsonDecoder(codec)) : $elm$json$Json$Decode$succeed(
...
var $author$project$Task$Entry$LeaderIsDeeper = function (a) {
	return {$: 'LeaderIsDeeper', a: a};
};
...
var $author$project$Replicated$Serialize$CustomTypeCodec = function (a) {
	return {$: 'CustomTypeCodec', a: a};
};
var $author$project$Replicated$Serialize$customType = function (match) {
	return $author$project$Replicated$Serialize$CustomTypeCodec(
		{
...
var $author$project$Replicated$Serialize$finishCustomType = function (_v0) {
	var am = _v0.a;
	return A4(
			...
			function (tag) {
				return A2(
					...
					$elm$bytes$Bytes$Decode$succeed(
						$elm$core$Result$Err($author$project$Replicated$Serialize$DataCorrupted)));
			},
			$elm$bytes$Bytes$Decode$unsignedInt16($author$project$Replicated$Serialize$endian)),
		A2(
			$elm$core$Basics$composeR,
			am.jsonMatch,
			function (_v3) {
...
var $author$project$Replicated$Serialize$lazy = function (f) {
	return A4(
		$author$project$Replicated$Serialize$build,
		function (value) {
			return A2(
		...
		A2(
			$elm$bytes$Bytes$Decode$andThen,
			function (_v0) {
				return $author$project$Replicated$Serialize$getBytesDecoder(
					f(_Utils_Tuple0));
			},
		...
		A2(
			$elm$json$Json$Decode$andThen,
			function (_v1) {
				return $author$project$Replicated$Serialize$getJsonDecoder(
					f(_Utils_Tuple0));
			},
...
var $author$project$Replicated$Serialize$findIndexHelp = F3(
...
var $author$project$Replicated$Serialize$findIndex = $author$project$Replicated$Serialize$findIndexHelp(0);
...
var $author$project$Replicated$Serialize$getAt = F2(
	function (idx, xs) {
...
var $author$project$Replicated$Serialize$enum = F2(
	function (defaultItem, items) {
		var getItem = function (index) {
			return (index < 0) ? $elm$core$Result$Err($author$project$Replicated$Serialize$DataCorrupted) : ((_Utils_cmp(
				index,
				$elm$core$List$length(items)) > 0) ? $elm$core$Result$Err($author$project$Replicated$Serialize$DataCorrupted) : $elm$core$Result$Ok(
				A2(
					$elm$core$Maybe$withDefault,
					defaultItem,
					A2($author$project$Replicated$Serialize$getAt, index - 1, items))));
		};
		var getIndex = function (value) {
			return 1 + A2(
				...
				-1,
				A2(
					$author$project$Replicated$Serialize$findIndex,
		...
		return A4(
			...
			A2(
				$elm$core$Basics$composeR,
				getIndex,
				$elm$bytes$Bytes$Encode$unsignedInt32($author$project$Replicated$Serialize$endian)),
			A2(
...
var $author$project$Task$Entry$Nested = function (a) {
	return {$: 'Nested', a: a};
};
...
var $author$project$Replicated$Serialize$int = A4(
	$author$project$Replicated$Serialize$build,
	A2(
		$elm$core$Basics$composeR,
		$elm$core$Basics$toFloat,
		$elm$bytes$Bytes$Encode$float64($author$project$Replicated$Serialize$endian)),
	A2(
		$elm$bytes$Bytes$Decode$map,
		A2($elm$core$Basics$composeR, $elm$core$Basics$round, $elm$core$Result$Ok),
		$elm$bytes$Bytes$Decode$float64($author$project$Replicated$Serialize$endian)),
...
var $author$project$Replicated$Serialize$listEncode = F2(
...
var $author$project$Replicated$Serialize$listStep = F2(
...
var $author$project$Replicated$Serialize$list = function (codec) {
	return A4(
		$author$project$Replicated$Serialize$build,
		$author$project$Replicated$Serialize$listEncode(
			$author$project$Replicated$Serialize$getEncoder(codec)),
		A2(
			$elm$bytes$Bytes$Decode$andThen,
			function (length) {
				return A2(
					...
					$author$project$Replicated$Serialize$listStep(
						$author$project$Replicated$Serialize$getBytesDecoder(codec)));
			},
			$elm$bytes$Bytes$Decode$unsignedInt32($author$project$Replicated$Serialize$endian)),
		$elm$json$Json$Encode$list(
			$author$project$Replicated$Serialize$getJsonEncoder(codec)),
		A2(
...
var $author$project$Replicated$Serialize$CustomError = function (a) {
	return {$: 'CustomError', a: a};
};
var $author$project$Replicated$Serialize$mapValid = F3(
				...
				function (value) {
					if (value.$ === 'Ok') {
						...
						return A2(
							...
							$author$project$Replicated$Serialize$CustomError,
							fromBytes_(ok));
					} else {
						var err = value.a;
						return $elm$core$Result$Err(err);
...
var $author$project$Task$Entry$nonEmptyCodec = function (wrappedCodec) {
	var nonEmptyFromList = function (list) {
		return A2(
			$elm$core$Result$fromMaybe,
			'the list was not supposed to be empty',
			$mgold$elm_nonempty_list$List$Nonempty$fromList(list));
	};
	return A3(
		$author$project$Replicated$Serialize$mapValid,
		nonEmptyFromList,
		$mgold$elm_nonempty_list$List$Nonempty$toList,
		$author$project$Replicated$Serialize$list(wrappedCodec));
};
var $author$project$Task$Class$ParentProperties = function (title) {
	return {title: title};
};
var $author$project$Replicated$Serialize$VariantEncoder = function (a) {
...
var $author$project$Replicated$Serialize$variant = F5(
	function (matchPiece, matchJsonPiece, decoderPiece, jsonDecoderPiece, _v0) {
		var am = _v0.a;
		var jsonEnc = function (v) {
			return $author$project$Replicated$Serialize$VariantEncoder(
				_Utils_Tuple2(
			...
			return $author$project$Replicated$Serialize$VariantEncoder(
				_Utils_Tuple2(
					$elm$bytes$Bytes$Encode$sequence(
						A2(
							$elm$core$List$cons,
							A2($elm$bytes$Bytes$Encode$unsignedInt16, $author$project$Replicated$Serialize$endian, am.idCounter),
							v)),
...
var $author$project$Replicated$Serialize$variant0 = function (ctor) {
	return A4(
		$author$project$Replicated$Serialize$variant,
		function (c) {
			return c(_List_Nil);
		},
		function (c) {
...
var $author$project$Replicated$Serialize$result1 = F2(
	function (ctor, value) {
		if (value.$ === 'Ok') {
			var ok = value.a;
			return $elm$core$Result$Ok(
...
var $author$project$Replicated$Serialize$variant1 = F2(
	function (ctor, m1) {
		return A4(
			$author$project$Replicated$Serialize$variant,
			F2(
				function (c, v) {
					return c(
						_List_fromArray(
							[
								A2($author$project$Replicated$Serialize$getEncoder, m1, v)
							]));
				}),
			F2(
				function (c, v) {
					return c(
						_List_fromArray(
							[
								A2($author$project$Replicated$Serialize$getJsonEncoder, m1, v)
							]));
				}),
			A2(
				$elm$bytes$Bytes$Decode$map,
				$author$project$Replicated$Serialize$result1(ctor),
				$author$project$Replicated$Serialize$getBytesDecoder(m1)),
			A2(
				$elm$json$Json$Decode$map,
				$author$project$Replicated$Serialize$result1(ctor),
				A2(
					$elm$json$Json$Decode$index,
					1,
					$author$project$Replicated$Serialize$getJsonDecoder(m1))));
	});
var $author$project$Replicated$Serialize$maybe = function (justCodec) {
	return $author$project$Replicated$Serialize$finishCustomType(
		A3(
			$author$project$Replicated$Serialize$variant1,
			$elm$core$Maybe$Just,
			justCodec,
			A2(
				$author$project$Replicated$Serialize$variant0,
				$elm$core$Maybe$Nothing,
				$author$project$Replicated$Serialize$customType(
					F3(
...
var $author$project$Task$Class$parentPropertiesCodec = $author$project$Replicated$Serialize$finishRecord(
	A3(
		$author$project$Replicated$Serialize$field,
		function ($) {
			return $.title;
		},
		$author$project$Replicated$Serialize$maybe($author$project$Replicated$Serialize$string),
		$author$project$Replicated$Serialize$record($author$project$Task$Class$ParentProperties)));
function $author$project$Task$Entry$cyclic$followerParentCodec() {
	return $author$project$Replicated$Serialize$finishRecord(
		A3(
			...
			$author$project$Task$Entry$nonEmptyCodec(
				$author$project$Task$Entry$cyclic$followerChildCodec()),
			A3(
				$author$project$Replicated$Serialize$field,
				function ($) {
					return $.properties;
				},
				$author$project$Task$Class$parentPropertiesCodec,
				$author$project$Replicated$Serialize$record($author$project$Task$Entry$FollowerParent))));
}
function $author$project$Task$Entry$cyclic$followerChildCodec() {
	return $author$project$Replicated$Serialize$finishCustomType(
		A3(
			$author$project$Replicated$Serialize$variant1,
			$author$project$Task$Entry$Nested,
			$author$project$Replicated$Serialize$lazy(
				function (_v1) {
					return $author$project$Task$Entry$cyclic$followerParentCodec();
				}),
			A3(
				$author$project$Replicated$Serialize$variant1,
				$author$project$Task$Entry$Singleton,
				$author$project$Replicated$Serialize$int,
				$author$project$Replicated$Serialize$customType(
					F3(
						function (singleton, nested, value) {
							if (value.$ === 'Singleton') {
								var classID = value.a;
								return singleton(classID);
							} else {
...
try {
	var $author$project$Task$Entry$followerParentCodec = $author$project$Task$Entry$cyclic$followerParentCodec();
	$author$project$Task$Entry$cyclic$followerParentCodec = function () {
		return $author$project$Task$Entry$followerParentCodec;
	};
	var $author$project$Task$Entry$followerChildCodec = $author$project$Task$Entry$cyclic$followerChildCodec();
	$author$project$Task$Entry$cyclic$followerChildCodec = function () {
		return $author$project$Task$Entry$followerChildCodec;
	};
} catch ($) {
	throw 'Some top-level definitions from `Task.Entry` are causing infinite recursion:\n\n  ┌─────┐\n  │    followerParentCodec\n  │     ↓\n  │    followerChildCodec\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
var $author$project$Task$Entry$leaderParentCodec = $author$project$Replicated$Serialize$finishRecord(
	A3(
		$author$project$Replicated$Serialize$field,
		function ($) {
			return $.children;
		},
		$author$project$Task$Entry$nonEmptyCodec($author$project$Task$Entry$followerParentCodec),
		A3(
			$author$project$Replicated$Serialize$field,
			function ($) {
				return $.recurrenceRules;
			},
			$author$project$Replicated$Serialize$maybe(
				A2($author$project$Replicated$Serialize$enum, $author$project$Task$Series$Series, _List_Nil)),
			A3(
				$author$project$Replicated$Serialize$field,
				function ($) {
					return $.properties;
				...
				$author$project$Task$Class$parentPropertiesCodec,
				$author$project$Replicated$Serialize$record($author$project$Task$Entry$LeaderParent)))));
function $author$project$Task$Entry$cyclic$wrapperParentCodec() {
	return $author$project$Replicated$Serialize$finishRecord(
		A3(
			$author$project$Replicated$Serialize$field,
			function ($) {
			...
			$author$project$Task$Entry$nonEmptyCodec(
				$author$project$Task$Entry$cyclic$wrapperChildCodec()),
			A3(
				$author$project$Replicated$Serialize$field,
				function ($) {
					return $.properties;
				...
				$author$project$Task$Class$parentPropertiesCodec,
				$author$project$Replicated$Serialize$record($author$project$Task$Entry$WrapperParent))));
}
function $author$project$Task$Entry$cyclic$wrapperChildCodec() {
	return $author$project$Replicated$Serialize$finishCustomType(
		A3(
			$author$project$Replicated$Serialize$variant1,
			$author$project$Task$Entry$LeaderIsHere,
			$author$project$Task$Entry$leaderParentCodec,
			A3(
				$author$project$Replicated$Serialize$variant1,
				$author$project$Task$Entry$LeaderIsDeeper,
				$author$project$Replicated$Serialize$lazy(
					function (_v1) {
						return $author$project$Task$Entry$cyclic$wrapperParentCodec();
					}),
				$author$project$Replicated$Serialize$customType(
					F3(
						function (leaderIsDeeper, leaderIsHere, value) {
							if (value.$ === 'LeaderIsDeeper') {
...
try {
	var $author$project$Task$Entry$wrapperParentCodec = $author$project$Task$Entry$cyclic$wrapperParentCodec();
	$author$project$Task$Entry$cyclic$wrapperParentCodec = function () {
		return $author$project$Task$Entry$wrapperParentCodec;
	};
	var $author$project$Task$Entry$wrapperChildCodec = $author$project$Task$Entry$cyclic$wrapperChildCodec();
	$author$project$Task$Entry$cyclic$wrapperChildCodec = function () {
		return $author$project$Task$Entry$wrapperChildCodec;
	};
} catch ($) {
	throw 'Some top-level definitions from `Task.Entry` are causing infinite recursion:\n\n  ┌─────┐\n  │    wrapperParentCodec\n  │     ↓\n  │    wrapperChildCodec\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
var $author$project$Task$Entry$decodeEntry = A2(
	$author$project$Helpers$customDecoder,
	$zwilias$json_decode_exploration$Json$Decode$Exploration$value,
	A2(
		$elm$core$Basics$composeL,
		$elm$core$Result$mapError(
			function (e) {
		...
		$author$project$Replicated$Serialize$decodeFromJson($author$project$Task$Entry$wrapperParentCodec)));
							...
							return function (plannedSessions) {
								return function (relevanceStarts) {
									return function (relevanceEnds) {
										return function (extra) {
											return {_class: _class, completion: completion, externalDeadline: externalDeadline, extra: extra, finishBy: finishBy, id: id, memberOfSeries: memberOfSeries, plannedSessions: plannedSessions, relevanceEnds: relevanceEnds, relevanceStarts: relevanceStarts, startBy: startBy};
										};
									};
								};
							};
...
var $author$project$Helpers$arrayAsTuple2 = F2(
	function (a, b) {
		return A2(
			$zwilias$json_decode_exploration$Json$Decode$Exploration$andThen,
			function (aVal) {
...
var $author$project$Helpers$decodeFuzzyMoment = A2($author$project$Helpers$customDecoder, $zwilias$json_decode_exploration$Json$Decode$Exploration$string, $author$project$SmartTime$Human$Moment$fuzzyFromString);
var $author$project$Task$SessionSkel$decodeSession = A2($author$project$Helpers$arrayAsTuple2, $author$project$Helpers$decodeFuzzyMoment, $author$project$Helpers$decodeDuration);
var $author$project$Task$Class$decodeTaskMoment = A2($author$project$Helpers$customDecoder, $zwilias$json_decode_exploration$Json$Decode$Exploration$string, $author$project$SmartTime$Human$Moment$fuzzyFromString);
var $author$project$Task$Instance$decodeInstance = A4(
	$zwilias$json_decode_exploration$Json$Decode$Exploration$Pipeline$optional,
	'extra',
	$zwilias$json_decode_exploration$Json$Decode$Exploration$dict($zwilias$json_decode_exploration$Json$Decode$Exploration$string),
	$elm$core$Dict$empty,
...
var $author$project$Helpers$decodeTuple2 = F2(
...
var $author$project$Helpers$decodeIntDict = function (valueDecoder) {
	return A2(
		$zwilias$json_decode_exploration$Json$Decode$Exploration$map,
		$elm_community$intdict$IntDict$fromList,
		$zwilias$json_decode_exploration$Json$Decode$Exploration$list(
			A2($author$project$Helpers$decodeTuple2, $zwilias$json_decode_exploration$Json$Decode$Exploration$int, valueDecoder)));
};
...
var $author$project$Activity$Activity$decodeDurationPerPeriod = A2($author$project$Helpers$arrayAsTuple2, $author$project$Activity$Activity$decodeHumanDuration, $author$project$Activity$Activity$decodeHumanDuration);
...
var $author$project$Helpers$decodeCustom = function (tagsWithDecoders) {
...
var $author$project$Activity$Activity$decodeExcusable = $author$project$Helpers$decodeCustom(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'NeverExcused',
...
var $author$project$Activity$Activity$decodeIcon = $author$project$Helpers$decodeCustom(
	_List_fromArray(
		[
...
var $author$project$Helpers$decodeCustomFlat = function (tags) {
	var justTag = $elm$core$Tuple$mapSecond($zwilias$json_decode_exploration$Json$Decode$Exploration$succeed);
	return $author$project$Helpers$decodeCustom(
		A2($elm$core$List$map, justTag, tags));
};
var $author$project$Activity$Template$decodeTemplate = $author$project$Helpers$decodeCustomFlat(
	_List_fromArray(
		[
...
var $author$project$Helpers$withPresence = F2(
...
var $author$project$Helpers$withPresenceList = F2(
	function (fieldName, decoder) {
		return A3(
			$zwilias$json_decode_exploration$Json$Decode$Exploration$Pipeline$optional,
			fieldName,
...
var $author$project$Activity$Activity$decodeCustomizations = A4(
	...
	A3(
		...
		A3(
			...
			A3(
				$author$project$Helpers$withPresence,
				'hidden',
				...
				A3(
					...
					A3(
						...
						A3(
							...
							A3(
								$author$project$Helpers$withPresenceList,
								'evidence',
...
var $author$project$Activity$Activity$decodeStoredActivities = A2(
	...
	$elm_community$intdict$IntDict$fromList,
	$zwilias$json_decode_exploration$Json$Decode$Exploration$list(
		A2($author$project$Helpers$decodeTuple2, $zwilias$json_decode_exploration$Json$Decode$Exploration$int, $author$project$Activity$Activity$decodeCustomizations)));
...
var $author$project$Helpers$decodeMoment = A2($zwilias$json_decode_exploration$Json$Decode$Exploration$map, $author$project$SmartTime$Moment$fromSmartInt, $zwilias$json_decode_exploration$Json$Decode$Exploration$int);
var $author$project$Activity$Switch$decodeSwitch = A4(
	...
	A3(
		...
		A3(
			$zwilias$json_decode_exploration$Json$Decode$Exploration$Pipeline$required,
			'Time',
			$author$project$Helpers$decodeMoment,
...
var $author$project$Replicated$Serialize$mapHelper = F3(
	function (fromBytes_, toBytes_, codec) {
		return A4(
			$author$project$Replicated$Serialize$build,
			function (v) {
...
var $author$project$Replicated$Serialize$map = F3(
	function (fromBytes_, toBytes_, codec) {
		return A3(
			$author$project$Replicated$Serialize$mapHelper,
			function (value) {
				if (value.$ === 'Ok') {
					var ok = value.a;
					return $elm$core$Result$Ok(
...
var $author$project$TimeBlock$TimeBlock$dateCodec = A3($author$project$Replicated$Serialize$map, $author$project$SmartTime$Human$Calendar$fromRataDie, $author$project$SmartTime$Human$Calendar$toRataDie, $author$project$Replicated$Serialize$int);
var $author$project$TimeBlock$TimeBlock$durationCodec = A3($author$project$Replicated$Serialize$map, $author$project$SmartTime$Duration$fromInt, $author$project$SmartTime$Duration$inMs, $author$project$Replicated$Serialize$int);
...
var $author$project$TimeBlock$TimeBlock$focusCodec = $author$project$Replicated$Serialize$finishCustomType(
	A3(
		$author$project$Replicated$Serialize$variant1,
		$author$project$TimeBlock$TimeBlock$Tag,
		$author$project$Replicated$Serialize$string,
		A3(
			$author$project$Replicated$Serialize$variant1,
			$author$project$TimeBlock$TimeBlock$Activity,
			A3($author$project$Replicated$Serialize$map, $author$project$ID$tag, $author$project$ID$read, $author$project$Replicated$Serialize$int),
			$author$project$Replicated$Serialize$customType(
				F3(
...
var $author$project$TimeBlock$TimeBlock$timeCodec = A3($author$project$Replicated$Serialize$mapValid, $author$project$SmartTime$Human$Clock$fromStandardString, $author$project$SmartTime$Human$Clock$toStandardString, $author$project$Replicated$Serialize$string);
var $author$project$TimeBlock$TimeBlock$codec = $author$project$Replicated$Serialize$finishRecord(
	A3(
		$author$project$Replicated$Serialize$field,
		function ($) {
			return $.duration;
		},
		$author$project$TimeBlock$TimeBlock$durationCodec,
		A3(
			$author$project$Replicated$Serialize$field,
			function ($) {
				return $.startTime;
			},
			$author$project$TimeBlock$TimeBlock$timeCodec,
			A3(
				$author$project$Replicated$Serialize$field,
				function ($) {
					return $.date;
				},
				$author$project$TimeBlock$TimeBlock$dateCodec,
				A3(
					$author$project$Replicated$Serialize$field,
					function ($) {
						return $.focus;
					...
					$author$project$Replicated$Serialize$record($author$project$TimeBlock$TimeBlock$TimeBlock))))));
var $author$project$TimeBlock$TimeBlock$decodeTimeBlock = A2(
	$author$project$Helpers$customDecoder,
	$zwilias$json_decode_exploration$Json$Decode$Exploration$value,
	A2(
		$elm$core$Basics$composeL,
		...
		$author$project$Replicated$Serialize$decodeFromJson($author$project$TimeBlock$TimeBlock$codec)));
...
var $author$project$Incubator$Todoist$decodeCache = A3(
	...
	A3(
		$zwilias$json_decode_exploration$Json$Decode$Exploration$Pipeline$required,
		'projects',
		$author$project$Helpers$decodeIntDict($author$project$Incubator$Todoist$Project$decodeProject),
		A3(
			$zwilias$json_decode_exploration$Json$Decode$Exploration$Pipeline$required,
			'items',
			$author$project$Helpers$decodeIntDict($author$project$Incubator$Todoist$Item$decodeItem),
			A4(
				$zwilias$json_decode_exploration$Json$Decode$Exploration$Pipeline$optional,
				'nextSync',
...
var $author$project$Profile$decodeTodoistIntegrationData = A3(
	$zwilias$json_decode_exploration$Json$Decode$Exploration$Pipeline$required,
	'activityProjectIDs',
	$author$project$Helpers$decodeIntDict($author$project$ID$decode),
	A3(
		$author$project$Helpers$withPresence,
		'parentProjectID',
		$zwilias$json_decode_exploration$Json$Decode$Exploration$int,
		...
		A4(
			...
			A4(
				...
				A4(
					$zwilias$json_decode_exploration$Json$Decode$Exploration$Pipeline$optional,
					'taskInstances',
					$author$project$Helpers$decodeIntDict($author$project$Task$Instance$decodeInstance),
					$elm_community$intdict$IntDict$empty,
					A4(
						$zwilias$json_decode_exploration$Json$Decode$Exploration$Pipeline$optional,
						'taskClasses',
						$author$project$Helpers$decodeIntDict($author$project$Task$Class$decodeClass),
						$elm_community$intdict$IntDict$empty,
						A4(
							$zwilias$json_decode_exploration$Json$Decode$Exploration$Pipeline$optional,
							'taskEntries',
...
var $author$project$Activity$Switch$getInstanceID = function (_v0) {
	var instanceIDMaybe = _v0.c;
	return instanceIDMaybe;
};
...
var $author$project$Activity$Timeline$placeNewSession = F2(
	function (switchList, _v0) {
		...
		var reSort = function (timeline) {
			return A2(
				...
				F2(
					function (a, b) {
						return A2(
							$author$project$SmartTime$Moment$compareEarliness,
							$author$project$Activity$Switch$getMoment(a),
							$author$project$Activity$Switch$getMoment(b));
					}),
				timeline);
		};
		...
		var indexedSwitchList = A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, switchList);
		var candidateEndAsSwitch = A3(
			$author$project$Activity$Switch$newSwitch,
			$author$project$SmartTime$Period$end(candidatePeriod),
			candidateActivityID,
			$elm$core$Maybe$Nothing);
		var candidateAsSwitch = A3(
			$author$project$Activity$Switch$newSwitch,
			$author$project$SmartTime$Period$start(candidatePeriod),
			candidateActivityID,
			candidateInstanceIDMaybe);
		...
		var foundEndSwitchAt = function (index) {
			return _Utils_eq(index, -1) ? true : _Utils_eq(
				A2(
					$elm$core$Maybe$map,
					alignsWithEnd,
					A2($elm_community$list_extra$List$Extra$getAt, index, switchList)),
				$elm$core$Maybe$Just(true));
		};
		var addEndingSwitch = function (startIndex) {
			return A3(insertAt, startIndex - 1, candidateEndAsSwitch, switchList);
		};
		if (!areaToSearch.b) {
			return reSort(
				A2($elm$core$List$cons, candidateAsSwitch, switchList));
		} else {
			if (!areaToSearch.b.b) {
				var _v2 = areaToSearch.a;
	...
	function (timeline, periodsToAdd) {
		if (!periodsToAdd.b) {
			...
			if (!periodsToAdd.b.b) {
				...
				return A2($author$project$Activity$Timeline$placeNewSession, timeline, singlePeriod);
			} else {
				var singlePeriod = periodsToAdd.a;
				var rest = periodsToAdd.b;
				return A2(
					$author$project$Activity$Timeline$placeNewSession,
					A2($author$project$Activity$Timeline$backfill, timeline, rest),
					singlePeriod);
			}
		}
	});
	...
	function (marvinItem, activities) {
		...
		if ((_v0.a.$ === 'Just') && (!_v0.b.b)) {
			...
			var matchingActivities = A2(
				...
				function (_v3) {
					var id = _v3.a;
					var associatedLabelMaybe = _v3.b;
...
var $author$project$Integrations$Marvin$MarvinItem$toDocketClassAndEntry = F3(
	function (classCounter, profile, marvinItem) {
		var pairClassWithMarvinIDMaybe = function (_class) {
			var _v2 = A2($elm$core$Dict$get, 'marvinGeneratorID', _class._class.extra);
			if (_v2.$ === 'Just') {
				var marvinID = _v2.a;
				return $elm$core$Maybe$Just(
					_Utils_Tuple2(marvinID, _class._class.id));
			} else {
				return $elm$core$Maybe$Nothing;
			}
		};
		var newClassID = classCounter + 1;
		...
		var updateExtraData = function (oldDict) {
			return A3(
				$elm$core$Dict$insert,
				'marvinID',
				marvinItem.id,
				A3($elm$core$Dict$insert, 'marvinGeneratorID', marvinGeneratorID, oldDict));
		};
		var _v0 = $author$project$Task$Entry$getClassesFromEntries(
			_Utils_Tuple2(profile.taskEntries, profile.taskClasses));
		...
		var existingClassMaybe = A2(
			...
			function (classID) {
				return A2($elm_community$intdict$IntDict$get, classID, profile.taskClasses);
			},
			existingClassIDMaybe);
		var classBase = A2(
			$elm$core$Maybe$withDefault,
			A2($author$project$Task$Class$newClassSkel, marvinItem.title, newClassID),
			existingClassMaybe);
		var finalClass = _Utils_update(
			classBase,
			{
				activity: A2($author$project$Integrations$Marvin$MarvinItem$determineClassActivity, marvinItem, profile.activities),
		...
		if (existingClassMaybe.$ === 'Just') {
			var existingClass = existingClassMaybe.a;
			return _Utils_Tuple2(finalClass, $elm$core$Maybe$Nothing);
		} else {
			return _Utils_Tuple2(
				finalClass,
				$elm$core$Maybe$Just(newEntry));
		}
	});
...
var $author$project$Integrations$Marvin$MarvinItem$toDocketInstance = F4(
	function (classCounter, _class, profile, marvinItem) {
		var plannedSessionList = function () {
			...
			while (true) {
				if (_v1.a.$ === 'Just') {
					if (_v1.a.a) {
						if (_v1.b.$ === 'Just') {
							var plannedDuration = _v1.b.a;
							var _v2 = _Utils_Tuple2(marvinItem.taskTime, marvinItem.day);
							if (_v2.a.$ === 'Just') {
								if (_v2.b.$ === 'Just') {
									var plannedTime = _v2.a.a;
									var plannedDay = _v2.b.a;
		...
		var pairInstanceWithMarvinIDMaybe = function (instance) {
			var _v0 = A2($elm$core$Dict$get, 'marvinID', instance.extra);
			if (_v0.$ === 'Just') {
				var marvinID = _v0.a;
				return $elm$core$Maybe$Just(
					_Utils_Tuple2(marvinID, instance.id));
			} else {
				return $elm$core$Maybe$Nothing;
			}
		};
		var existingInstancesWithMarvinLink = $elm$core$Dict$fromList(
			A2(
				...
				$elm_community$intdict$IntDict$values(profile.taskInstances)));
		var existingInstanceIDMaybe = A2($elm$core$Dict$get, marvinItem.id, existingInstancesWithMarvinLink);
		var existingInstanceMaybe = A2(
			$elm$core$Maybe$andThen,
			function (instanceID) {
				return A2($elm_community$intdict$IntDict$get, instanceID, profile.taskInstances);
			},
			existingInstanceIDMaybe);
		var instanceBase = A2(
			$elm$core$Maybe$withDefault,
			A2($author$project$Task$Instance$newInstanceSkel, classCounter, _class),
			existingInstanceMaybe);
		var boolAsString = function (bool) {
			return bool ? 'True' : 'False';
		};
		var addExtras = $elm$core$Dict$fromList(
			A2(
				$elm$core$List$filterMap,
				$elm$core$Basics$identity,
				_List_fromArray(
					[
						...
						_Utils_Tuple2(
							'marvinMasterRank',
							$elm$core$String$fromInt(marvinItem.masterRank))),
						$elm$core$Maybe$Just(
						_Utils_Tuple2(
							'marvinCreatedAt',
		...
		var finalInstance = _Utils_update(
			instanceBase,
			{
				...
				extra: A2($elm$core$Dict$union, addExtras, instanceBase.extra),
				finishBy: A2(
				...
				relevanceEnds: $elm_community$maybe_extra$Maybe$Extra$isJust(marvinItem.recurringTaskId) ? A2($elm$core$Maybe$map, $author$project$SmartTime$Human$Moment$DateOnly, marvinItem.day) : $elm$core$Maybe$Nothing,
				relevanceStarts: $elm_community$maybe_extra$Maybe$Extra$isJust(marvinItem.recurringTaskId) ? A2($elm$core$Maybe$map, $author$project$SmartTime$Human$Moment$DateOnly, marvinItem.day) : $elm$core$Maybe$Nothing,
		...
		var classCounter = A2(
			...
			A2(
				...
				$elm_community$list_extra$List$Extra$last(
					$elm_community$intdict$IntDict$toList(profile.taskClasses))));
		var _v0 = A3($author$project$Integrations$Marvin$MarvinItem$toDocketClassAndEntry, classCounter, profile, marvinItem);
		var finalClass = _v0.a;
		var newEntryMaybe = _v0.b;
		var finalInstance = A4($author$project$Integrations$Marvin$MarvinItem$toDocketInstance, classCounter, finalClass, profile, marvinItem);
		return {
			classes: _List_fromArray(
				[finalClass]),
			entries: $elm_community$maybe_extra$Maybe$Extra$toList(newEntryMaybe),
			instances: _List_fromArray(
				[finalInstance])
		};
	});
var $author$project$Integrations$Marvin$MarvinItem$toDocketItem = F2(
	function (marvinItem, profile) {
		var _v0 = marvinItem.db;
		if (_v0 === 'Tasks') {
			return $author$project$Integrations$Marvin$MarvinItem$ConvertedToTaskTriplet(
				A2($author$project$Integrations$Marvin$MarvinItem$toDocketTask, profile, marvinItem));
		} else {
...
var $author$project$Integrations$Marvin$importItems = F2(
	function (profile, itemList) {
		...
		var updateProfileWithOutput = F2(
			function (item, beforeProfile) {
				var output = A2($author$project$Integrations$Marvin$MarvinItem$toDocketItem, item, beforeProfile);
				var tasks = $elm_community$maybe_extra$Maybe$Extra$toList(
					tasksOnly(output));
				var activities = $elm_community$maybe_extra$Maybe$Extra$toList(
					activitiesOnly(output));
				return _Utils_update(
					beforeProfile,
					{
						activities: A3(
							...
							F2(
								function (d1, d2) {
									return A2($elm_community$intdict$IntDict$union, d2, d1);
								}),
							beforeProfile.activities,
							activities),
						taskClasses: A2(
							...
							$elm_community$intdict$IntDict$fromList(
								A2(
									...
									A2(
										...
										tasks))),
							beforeProfile.taskClasses),
						taskEntries: _Utils_ap(
							beforeProfile.taskEntries,
							A2(
								$elm$core$List$concatMap,
								function ($) {
									return $.entries;
...
var $author$project$Integrations$Marvin$MarvinItem$marvinTimeBlockToDocketTimeBlock = F3(
	function (profile, assignments, marvinBlock) {
		...
		var labelMaybe = A2(
			...
			normalizeTitle(marvinBlock.title),
			assignments);
		var createActivityLookupEntry = function (_v3) {
			var activityID = _v3.a;
			var activity = _v3.b;
			var _v2 = A2($elm$core$Dict$get, 'marvinLabel', activity.externalIDs);
			if (_v2.$ === 'Nothing') {
				return $elm$core$Maybe$Nothing;
			} else {
		...
		var buildWithTag = function (tag) {
			return {
				date: marvinBlock.date,
				duration: marvinBlock.duration,
				focus: $author$project$TimeBlock$TimeBlock$Tag(tag),
				startTime: marvinBlock.time
			};
		};
		var buildWithActivity = function (activityFound) {
			return {
				date: marvinBlock.date,
				duration: marvinBlock.duration,
				focus: $author$project$TimeBlock$TimeBlock$Activity(activityFound),
				startTime: marvinBlock.time
			};
		};
		var activityLookup = $elm$core$Dict$fromList(
			A2(
				...
				$elm_community$intdict$IntDict$toList(
					$author$project$Activity$Activity$allActivities(profile.activities))));
...
var $author$project$Integrations$Marvin$handle = F4(
	function (classCounter, profile, env, response) {
		switch (response.$) {
			case 'TestResult':
				var result = response.a;
				if (result.$ === 'Ok') {
					var serversays = result.a;
					return _Utils_Tuple3(profile, serversays, $elm$core$Platform$Cmd$none);
				} else {
					var err = result.a;
					return _Utils_Tuple3(
						profile,
...
var $author$project$Activity$Timeline$fullPeriodFromSwitchPair = F2(
	function (newerSwitch, olderSwitch) {
		return _Utils_Tuple3(
			$author$project$Activity$Switch$getActivityID(olderSwitch),
			$author$project$Activity$Switch$getInstanceID(olderSwitch),
			$author$project$SmartTime$Period$fromPair(
				_Utils_Tuple2(
					$author$project$Activity$Switch$getMoment(newerSwitch),
					$author$project$Activity$Switch$getMoment(olderSwitch))));
	});
var $author$project$Activity$Timeline$switchListToInstancePeriods = function (switchList) {
	var offsetList = A2($elm$core$List$drop, 1, switchList);
	var maybeInstanceToMaybePair = function (_v1) {
		var activityID = _v1.a;
		var maybeInstanceID = _v1.b;
		var period = _v1.c;
		if (maybeInstanceID.$ === 'Just') {
			var instanceID = maybeInstanceID.a;
			return $elm$core$Maybe$Just(
				_Utils_Tuple3(activityID, instanceID, period));
		} else {
			return $elm$core$Maybe$Nothing;
		}
	};
	var listWithBlanks = A3($elm$core$List$map2, $author$project$Activity$Timeline$fullPeriodFromSwitchPair, switchList, offsetList);
	return A2($elm$core$List$filterMap, maybeInstanceToMaybePair, listWithBlanks);
};
var $author$project$Activity$Timeline$getInstancePeriods = F2(
	function (timeline, instanceID) {
		return A2(
			$elm$core$List$map,
			function (_v0) {
				var p = _v0.c;
			...
			A2(
				...
				function (_v1) {
					...
					var i = _v1.b;
					var p = _v1.c;
					return _Utils_eq(i, instanceID);
				},
				$author$project$Activity$Timeline$switchListToInstancePeriods(timeline)));
	});
...
var $author$project$Activity$Timeline$getInstanceTimes = F2(
	function (timeline, instanceID) {
		var periods = A2(
			$elm$core$List$map,
			$author$project$SmartTime$Period$toPair,
			A2($author$project$Activity$Timeline$getInstancePeriods, timeline, instanceID));
		var timesList = A2(
			$elm$core$List$concatMap,
			function (_v0) {
				var a = _v0.a;
			...
			periods);
		return A2($elm_community$list_extra$List$Extra$uniqueBy, $author$project$SmartTime$Moment$toSmartInt, timesList);
	});
var $author$project$Integrations$Marvin$timesUpdater = F2(
	function (profile, instanceID) {
		var timesList = A2($author$project$Activity$Timeline$getInstanceTimes, profile.timeline, instanceID);
		return A2(
			$elm$json$Json$Encode$encode,
			0,
			A2($elm$json$Json$Encode$list, $author$project$Helpers$encodeUnixTimestamp, timesList));
	});
var $author$project$Integrations$Marvin$MarvinItem$encodeCalendarDate = function (date) {
	return $elm$json$Json$Encode$string(
		$author$project$SmartTime$Human$Calendar$toStandardString(date));
};
var $author$project$Helpers$encodeDuration = function (dur) {
	return $elm$json$Json$Encode$int(
		$author$project$SmartTime$Duration$inMs(dur));
};
var $author$project$Integrations$Marvin$MarvinItem$encodeMonth = function (_v0) {
	var year = _v0.a;
	var month = _v0.b;
	return $elm$json$Json$Encode$string(
		_Utils_ap(
			$author$project$SmartTime$Human$Calendar$Year$toString(year),
			$elm$core$String$fromInt(
				$author$project$SmartTime$Human$Calendar$Month$toInt(month))));
};
var $author$project$Integrations$Marvin$MarvinItem$encodeTimeOfDay = function (clock) {
	return $elm$json$Json$Encode$string(
		$author$project$SmartTime$Human$Clock$toStandardString(clock));
};
var $author$project$Helpers$omittableBool = function (_v0) {
	var name = _v0.a;
	var encoder = _v0.b;
	var fieldToCheck = _v0.c;
	return fieldToCheck ? $elm$core$Maybe$Just(
		_Utils_Tuple2(
			name,
			encoder(fieldToCheck))) : $elm$core$Maybe$Nothing;
};
var $author$project$Helpers$omittableNum = function (_v0) {
	var name = _v0.a;
	var encoder = _v0.b;
	var fieldToCheck = _v0.c;
	return (!(!fieldToCheck)) ? $elm$core$Maybe$Just(
...
var $author$project$Integrations$Marvin$MarvinItem$encodeMarvinItem = function (task) {
	return $author$project$Helpers$encodeObjectWithoutNothings(
		_List_fromArray(
			[
				$author$project$Helpers$normal(
				...
				_Utils_Tuple2(
					'_rev',
					$elm$json$Json$Encode$string(task.rev))),
				$author$project$Helpers$omittableBool(
				_Utils_Tuple3('done', $elm$json$Json$Encode$bool, task.done)),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('day', $author$project$Integrations$Marvin$MarvinItem$encodeCalendarDate, task.day)),
				$author$project$Helpers$normal(
				_Utils_Tuple2(
					'title',
				...
				_Utils_Tuple2(
					'parentId',
					$elm$json$Json$Encode$string(
						A2($elm$core$Maybe$withDefault, 'unassigned', task.parentId)))),
				$author$project$Helpers$omittableList(
				_Utils_Tuple3('labelIds', $elm$json$Json$Encode$string, task.labelIds)),
				$author$project$Helpers$normal(
				_Utils_Tuple2(
					'firstScheduled',
					A2(
						$elm$core$Maybe$withDefault,
						$elm$json$Json$Encode$string('unassigned'),
						A2($elm$core$Maybe$map, $author$project$Integrations$Marvin$MarvinItem$encodeCalendarDate, task.firstScheduled)))),
				$author$project$Helpers$normal(
				_Utils_Tuple2(
					'rank',
					$elm$json$Json$Encode$int(task.rank))),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('dailySection', $elm$json$Json$Encode$string, task.dailySection)),
				$author$project$Helpers$normal(
				_Utils_Tuple2(
					'bonusSection',
					$author$project$Integrations$Marvin$MarvinItem$encodeEssentialOrBonus(task.bonusSection))),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('customSection', $elm$json$Json$Encode$string, task.customSection)),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('timeBlockSection', $elm$json$Json$Encode$string, task.timeBlockSection)),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('note', $elm$json$Json$Encode$string, task.note)),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('dueDate', $author$project$Integrations$Marvin$MarvinItem$encodeCalendarDate, task.dueDate)),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('timeEstimate', $author$project$Helpers$encodeDuration, task.timeEstimate)),
				$author$project$Helpers$omittableBool(
				_Utils_Tuple3('isReward', $elm$json$Json$Encode$bool, task.isReward)),
				$author$project$Helpers$omittableNum(
				_Utils_Tuple3('isStarred', $elm$json$Json$Encode$int, task.isStarred)),
				$author$project$Helpers$omittableNum(
				_Utils_Tuple3('isFrogged', $elm$json$Json$Encode$int, task.isFrogged)),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('plannedWeek', $author$project$Integrations$Marvin$MarvinItem$encodeCalendarDate, task.plannedWeek)),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('plannedMonth', $author$project$Integrations$Marvin$MarvinItem$encodeMonth, task.plannedMonth)),
				$author$project$Helpers$omittableNum(
				_Utils_Tuple3('rewardPoints', $elm$json$Json$Encode$float, task.rewardPoints)),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('rewardId', $elm$json$Json$Encode$string, task.rewardId)),
				$author$project$Helpers$omittableBool(
				_Utils_Tuple3('backburner', $elm$json$Json$Encode$bool, task.backburner)),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('reviewDate', $author$project$Integrations$Marvin$MarvinItem$encodeCalendarDate, task.reviewDate)),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('itemSnoozeTime', $author$project$Helpers$encodeUnixTimestamp, task.itemSnoozeTime)),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('permaSnoozeTime', $author$project$Integrations$Marvin$MarvinItem$encodeTimeOfDay, task.permaSnoozeTime)),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('timeZoneOffset', $elm$json$Json$Encode$int, task.timeZoneOffset)),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('startDate', $author$project$Integrations$Marvin$MarvinItem$encodeCalendarDate, task.startDate)),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('endDate', $author$project$Integrations$Marvin$MarvinItem$encodeCalendarDate, task.endDate)),
				$author$project$Helpers$normal(
				_Utils_Tuple2(
					'db',
					$elm$json$Json$Encode$string(task.db))),
				$author$project$Helpers$omittableList(
				_Utils_Tuple3('times', $author$project$Helpers$encodeUnixTimestamp, task.times)),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('taskTime', $author$project$Integrations$Marvin$MarvinItem$encodeTimeOfDay, task.taskTime)),
				$author$project$Helpers$omittableNum(
				_Utils_Tuple3('masterRank', $elm$json$Json$Encode$int, task.masterRank)),
				$author$project$Helpers$normal(
				_Utils_Tuple2(
					'createdAt',
					$author$project$Helpers$encodeUnixTimestamp(task.createdAt))),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('doneAt', $author$project$Helpers$encodeUnixTimestamp, task.doneAt)),
				$author$project$Helpers$omittable(
				_Utils_Tuple3('updatedAt', $author$project$Helpers$encodeUnixTimestamp, task.updatedAt)),
				$author$project$Helpers$normal(
				_Utils_Tuple2(
					'fieldUpdates',
...
var $author$project$Integrations$Marvin$MarvinItem$parseTimesList = function (timesList) {
	...
	return A2(
		...
		$elm$core$Result$toMaybe(
			$zwilias$json_decode_exploration$Json$Decode$Exploration$strict(decodeResult)));
};
var $elm$core$String$words = _String_words;
var $author$project$Integrations$Marvin$MarvinItem$fromDocket = function (instance) {
	var useDecoder = F2(
		function (decoder, string) {
			return $elm$core$Result$toMaybe(
				$zwilias$json_decode_exploration$Json$Decode$Exploration$strict(
					A2($zwilias$json_decode_exploration$Json$Decode$Exploration$decodeString, decoder, string)));
		});
	var toDate = $elm$core$Maybe$andThen(
		A2($elm$core$Basics$composeR, $author$project$SmartTime$Human$Calendar$fromNumberString, $elm$core$Result$toMaybe));
	var toBool = function (boolString) {
		return boolString === 'True';
	};
	var revMaybe = A2($elm$core$Dict$get, 'marvinCouchdbRev', instance.instance.extra);
	var idMaybe = A2($elm$core$Dict$get, 'marvinID', instance.instance.extra);
	var _v0 = _Utils_Tuple2(idMaybe, revMaybe);
		...
		return $elm$core$Maybe$Just(
			{
				backburner: A2(
					...
					A2(
						$elm$core$Maybe$map,
						toBool,
						A2($elm$core$Dict$get, 'marvinBackburner', instance.instance.extra))),
				bonusSection: A2(
					$elm$core$Maybe$withDefault,
					$author$project$Integrations$Marvin$MarvinItem$Essential,
					A2(
						$elm$core$Maybe$andThen,
						useDecoder($author$project$Integrations$Marvin$MarvinItem$essentialOrBonusDecoder),
						A2($elm$core$Dict$get, 'marvinEssentialOrBonus', instance.instance.extra))),
				createdAt: A2(
					$elm$core$Maybe$withDefault,
					$author$project$SmartTime$Moment$zero,
					A2(
						$elm$core$Maybe$andThen,
						A2($elm$core$Basics$composeR, $author$project$SmartTime$Human$Moment$fromStandardStringLoose, $elm$core$Result$toMaybe),
						A2($elm$core$Dict$get, 'marvinCreatedAt', instance.instance.extra))),
				customSection: A2($elm$core$Dict$get, 'marvinCustomSection', instance.instance.extra),
				dailySection: A2($elm$core$Dict$get, 'marvinDailySection', instance.instance.extra),
				day: toDate(
					A2($elm$core$Dict$get, 'marvinDay', instance.instance.extra)),
				db: A2(
					$elm$core$Maybe$withDefault,
					'tasks',
					A2($elm$core$Dict$get, 'marvinDb', instance.instance.extra)),
				done: A3($elm$core$Debug$log, 'checking completion', $author$project$Task$Instance$completed, instance),
				doneAt: A2(
					$elm$core$Maybe$andThen,
					A2($elm$core$Basics$composeR, $author$project$SmartTime$Human$Moment$fromStandardStringLoose, $elm$core$Result$toMaybe),
					A2($elm$core$Dict$get, 'marvinDoneAt', instance.instance.extra)),
				dueDate: toDate(
					A2($elm$core$Dict$get, 'marvinDueDate', instance.instance.extra)),
				endDate: toDate(
					A2($elm$core$Dict$get, 'marvinEndDate', instance.instance.extra)),
				fieldUpdates: A2(
					$elm$core$Maybe$withDefault,
					$elm$core$Dict$empty,
					A2(
						...
						useDecoder(
							$zwilias$json_decode_exploration$Json$Decode$Exploration$dict($author$project$Helpers$decodeUnixTimestamp)),
						A2($elm$core$Dict$get, 'marvinFieldUpdates', instance.instance.extra))),
				firstScheduled: toDate(
					A2($elm$core$Dict$get, 'marvinFirstScheduled', instance.instance.extra)),
				id: id,
				isFrogged: A2(
					$elm$core$Maybe$withDefault,
					0,
					A2(
						...
						A2($elm$core$Dict$get, 'marvinIsFrogged', instance.instance.extra))),
				isReward: A2(
					$elm$core$Maybe$withDefault,
					false,
					A2(
						$elm$core$Maybe$map,
						toBool,
						A2($elm$core$Dict$get, 'marvinIsReward', instance.instance.extra))),
				isStarred: A2(
					$elm$core$Maybe$withDefault,
					0,
					A2(
						$elm$core$Maybe$andThen,
						$elm$core$String$toInt,
						A2($elm$core$Dict$get, 'marvinIsStarred', instance.instance.extra))),
				itemSnoozeTime: A2(
					$elm$core$Maybe$andThen,
					A2($elm$core$Basics$composeR, $author$project$SmartTime$Human$Moment$fromStandardStringLoose, $elm$core$Result$toMaybe),
					A2($elm$core$Dict$get, 'marvinItemSnoozeTime', instance.instance.extra)),
				labelIds: A2(
					$elm$core$Maybe$withDefault,
					_List_Nil,
					A2(
						...
						A2($elm$core$Dict$get, 'marvinLabels', instance.instance.extra))),
				masterRank: A2(
					$elm$core$Maybe$withDefault,
					0,
					A2(
						$elm$core$Maybe$andThen,
						$elm$core$String$toInt,
						A2($elm$core$Dict$get, 'marvinMasterRank', instance.instance.extra))),
				note: A2($elm$core$Dict$get, 'marvinNote', instance.instance.extra),
				parentId: A2($elm$core$Dict$get, 'marvinParentID', instance.instance.extra),
				permaSnoozeTime: A2(
					$elm$core$Maybe$andThen,
					A2($elm$core$Basics$composeR, $author$project$SmartTime$Human$Clock$fromStandardString, $elm$core$Result$toMaybe),
					A2($elm$core$Dict$get, 'marvinPermaSnoozeTime', instance.instance.extra)),
				pinId: A2($elm$core$Dict$get, 'marvinPinID', instance.instance.extra),
				plannedMonth: $elm$core$Maybe$Nothing,
				plannedWeek: toDate(
					A2($elm$core$Dict$get, 'marvinPlannedWeek', instance.instance.extra)),
				rank: A2(
					$elm$core$Maybe$withDefault,
					0,
					A2(
						$elm$core$Maybe$andThen,
						$elm$core$String$toInt,
						A2($elm$core$Dict$get, 'marvinRank', instance.instance.extra))),
				recurringTaskId: A2($elm$core$Dict$get, 'recurringTaskID', instance.instance.extra),
				rev: rev,
				reviewDate: toDate(
					A2($elm$core$Dict$get, 'marvinReviewDate', instance.instance.extra)),
				rewardId: A2($elm$core$Dict$get, 'marvinRewardID', instance.instance.extra),
				rewardPoints: 0,
				startDate: toDate(
					A2($elm$core$Dict$get, 'marvinStartDate', instance.instance.extra)),
				taskTime: A2(
					$elm$core$Maybe$andThen,
					A2($elm$core$Basics$composeR, $author$project$SmartTime$Human$Clock$fromStandardString, $elm$core$Result$toMaybe),
					A2($elm$core$Dict$get, 'marvinTaskTime', instance.instance.extra)),
				timeBlockSection: A2($elm$core$Dict$get, 'marvinTimeBlockSection', instance.instance.extra),
				timeEstimate: $elm$core$Maybe$Just(instance._class.predictedEffort),
				timeZoneOffset: A2(
					$elm$core$Maybe$andThen,
					$elm$core$String$toInt,
					A2($elm$core$Dict$get, 'marvinTimeZoneOffset', instance.instance.extra)),
				times: $author$project$Integrations$Marvin$MarvinItem$parseTimesList(
					A2(
						$elm$core$Maybe$withDefault,
						'[]',
						A2($elm$core$Dict$get, 'marvinTimes', instance.instance.extra))),
				title: instance._class.title,
				updatedAt: A2(
					$elm$core$Maybe$andThen,
					A2($elm$core$Basics$composeR, $author$project$SmartTime$Human$Moment$fromStandardStringLoose, $elm$core$Result$toMaybe),
					A2($elm$core$Dict$get, 'marvinUpdatedAt', instance.instance.extra))
			});
	} else {
		return $elm$core$Maybe$Nothing;
	}
...
var $author$project$Integrations$Marvin$updateDoc = F3(
	function (timestamp, updatedFields, taskInstance) {
		var asMarvinItem = $author$project$Integrations$Marvin$MarvinItem$fromDocket(taskInstance);
		if (asMarvinItem.$ === 'Just') {
			var marvinItem = asMarvinItem.a;
			var stampedItem = _Utils_update(
				marvinItem,
				{
					createdAt: A2($elm$core$List$member, 'createdAt', updatedFields) ? timestamp : marvinItem.createdAt,
					doneAt: A2($elm$core$List$member, 'done', updatedFields) ? $elm$core$Maybe$Just(timestamp) : marvinItem.doneAt,
					fieldUpdates: A2(
						$elm$core$Dict$union,
						$elm$core$Dict$fromList(
							A2(
								$elm$core$List$map,
								function (f) {
									return _Utils_Tuple2(f, timestamp);
								},
								updatedFields)),
						marvinItem.fieldUpdates),
					updatedAt: $elm$core$Maybe$Just(timestamp)
				});
			return $elm$http$Http$request(
				{
					body: $elm$http$Http$jsonBody(
						$author$project$Integrations$Marvin$MarvinItem$encodeMarvinItem(stampedItem)),
					expect: A2(
						$elm$http$Http$expectJson,
						$author$project$Integrations$Marvin$GotItems,
						$author$project$Helpers$toClassicLoose(
					...
					url: A2(
						$author$project$Integrations$Marvin$marvinCloudantDatabaseUrl,
						_List_fromArray(
							[$author$project$Integrations$Marvin$syncDatabase, marvinItem.id]),
						_List_Nil)
				});
		} else {
...
var $author$project$Integrations$Marvin$marvinUpdateCurrentlyTracking = F4(
	function (profile, env, instanceIDMaybe, starting) {
		...
		if (_v0.$ === 'Just') {
			var instance = _v0.a;
			var _v1 = A2($author$project$Task$Instance$getExtra, 'marvinID', instance);
			if (_v1.$ === 'Nothing') {
				return _Utils_Tuple2(
					profile,
					A2($elm$core$Debug$log, 'No MarvinID found', $elm$core$Platform$Cmd$none));
			} else {
				var marvinID = _v1.a;
				var trackCmd = A3($author$project$Integrations$Marvin$timeTrack, $author$project$Integrations$Marvin$partialAccessToken, marvinID, starting);
				var instanceSkel = instance.instance;
				var updatedInstanceSkel = _Utils_update(
					instanceSkel,
					{
						extra: A3(
							$elm$core$Dict$insert,
							'marvinTimes',
							A2(
								$author$project$Integrations$Marvin$timesUpdater,
								profile,
								$author$project$Task$Instance$getID(instance)),
							instanceSkel.extra)
					});
				var updateTimesCmd = A3(
					...
					_Utils_update(
						instance,
						{instance: updatedInstanceSkel}));
				var updatedInstanceDict = A3(
					$elm_community$intdict$IntDict$insert,
					$author$project$Task$Instance$getID(instance),
					updatedInstanceSkel,
					profile.taskInstances);
				var updatedProfile = _Utils_update(
					profile,
					{taskInstances: updatedInstanceDict});
				return _Utils_Tuple2(
					updatedProfile,
			...
			return _Utils_Tuple2(
				profile,
				A3($author$project$Log$logSeparate, 'No Instance found for ID', instanceIDMaybe, $elm$core$Platform$Cmd$none));
		}
	});
	...
	function (msg, state, app, env) {
		switch (msg.$) {
			...
			case 'UpdateProgress':
				...
				var updateTaskInstance = function (t) {
					return _Utils_update(
						t,
						{completion: new_completion});
				};
				var profile1WithUpdatedInstance = _Utils_update(
					app,
					{
						taskInstances: A3(
							$elm_community$intdict$IntDict$update,
							givenTask.instance.id,
							$elm$core$Maybe$map(updateTaskInstance),
							app.taskInstances)
					});
				...
				while (true) {
					if (!_v4.a) {
						if (_v4.b) {
							var _v5 = A4(
								$author$project$TaskList$update,
								$author$project$TaskList$StopTracking(
									$author$project$Task$Instance$getID(givenTask)),
								state,
								profile1WithUpdatedInstance,
								env);
							var viewState2 = _v5.a;
							var profile2WithTrackingStopped = _v5.b;
							var trackingStoppedCmds = _v5.c;
							return _Utils_Tuple3(
								viewState2,
										...
										[
											...
											A3(
												...
												_Utils_update(
													givenTask,
													{
														instance: updateTaskInstance(givenTask.instance)
													}))),
											trackingStoppedCmds
										])));
						} else {
				...
				return _Utils_Tuple3(state, profile1WithUpdatedInstance, $elm$core$Platform$Cmd$none);
			case 'FocusSlider':
				var task = msg.a;
				var focused = msg.b;
				return _Utils_Tuple3(state, app, $elm$core$Platform$Cmd$none);
			...
			case 'TodoistServerResponse':
				var response = msg.a;
				var _v6 = A2($author$project$Integrations$Todoist$handle, response, app);
				var newAppData = _v6.a;
				var whatHappened = _v6.b;
				return _Utils_Tuple3(
					state,
					newAppData,
			...
			case 'StartTracking':
				...
				var _v9 = A4(
					...
					$elm$core$Maybe$Just(instanceID),
					true);
				var newProfile2WithMarvinTimes = _v9.a;
				var marvinCmds = _v9.b;
				return _Utils_Tuple3(
					state,
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								A2($elm$core$Platform$Cmd$map, $author$project$TaskList$MarvinServerResponse, marvinCmds),
								switchCommands
							])));
			default:
				var instanceID = msg.a;
				var instanceToStop = $author$project$Activity$Timeline$currentInstanceID(app.timeline);
				var activityToContinue = $author$project$Activity$Timeline$currentActivityID(app.timeline);
...
var $author$project$TimeTracker$writeActivityUsage = F3(
	function (app, env, _v0) {
		...
		var lastPeriod = A3($author$project$Activity$Timeline$relevantTimeline, app.timeline, env.time, period);
		var total = A3($author$project$Activity$Timeline$totalLive, env.time, lastPeriod, activityID);
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'minEffort',
				$author$project$Helpers$encodeDuration(taskClass.minEffort)),
				_Utils_Tuple2(
				'predictedEffort',
				$author$project$Helpers$encodeDuration(taskClass.predictedEffort)),
				_Utils_Tuple2(
				'maxEffort',
				$author$project$Helpers$encodeDuration(taskClass.maxEffort)),
				_Utils_Tuple2(
				'defaultExternalDeadline',
				...
				_Utils_Tuple2(
				'extra',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $elm$json$Json$Encode$string, taskClass.extra))
			]));
};
...
var $author$project$Task$Entry$encodeEntry = function (entry) {
	return A2($author$project$Replicated$Serialize$encodeToJson, $author$project$Task$Entry$wrapperParentCodec, entry);
};
...
var $author$project$Helpers$encodeFuzzyMoment = function (fuzzy) {
	return $elm$json$Json$Encode$string(
...
var $author$project$Task$SessionSkel$encodeSession = function (plannedSession) {
	return A3($author$project$Helpers$encodeTuple2, $author$project$Helpers$encodeFuzzyMoment, $author$project$Helpers$encodeDuration, plannedSession);
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'extra',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $elm$json$Json$Encode$string, taskInstance.extra))
			]));
};
...
var $author$project$Helpers$homogeneousTuple2AsArray = F2(
...
var $author$project$Activity$Activity$encodeDurationPerPeriod = function (tuple) {
	return A2($author$project$Helpers$homogeneousTuple2AsArray, $author$project$Activity$Activity$encodeHumanDuration, tuple);
};
...
var $author$project$Activity$Activity$encodeStoredActivities = function (value) {
	return A2(
		$elm$json$Json$Encode$list,
		A2($author$project$Helpers$encodeTuple2, $elm$json$Json$Encode$int, $author$project$Activity$Activity$encodeCustomizations),
...
var $author$project$Helpers$encodeMoment = function (dur) {
	return $elm$json$Json$Encode$int(
		...
		_Utils_ap(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'Time',
					$author$project$Helpers$encodeMoment(time)),
					_Utils_Tuple2(
					'Activity',
...
var $author$project$TimeBlock$TimeBlock$encodeTimeBlock = function (timeBlock) {
	return A2($author$project$Replicated$Serialize$encodeToJson, $author$project$TimeBlock$TimeBlock$codec, timeBlock);
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'collapsed',
				$author$project$Helpers$encodeBoolToInt(record.collapsed)),
				_Utils_Tuple2(
				'children',
				...
				_Utils_Tuple2(
				'checked',
				$author$project$Helpers$encodeBoolToInt(record.checked)),
				_Utils_Tuple2(
				'in_history',
				$author$project$Helpers$encodeBoolToInt(record.in_history)),
				_Utils_Tuple2(
				'is_deleted',
				$author$project$Helpers$encodeBoolToInt(record.is_deleted)),
				_Utils_Tuple2(
				'is_archived',
				$author$project$Helpers$encodeBoolToInt(record.is_archived)),
				_Utils_Tuple2(
				'date_added',
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'is_favorite',
				$author$project$Helpers$encodeBoolToInt(record.is_favorite)),
				_Utils_Tuple2(
				'inbox_project',
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'items',
				A2($author$project$Helpers$encodeIntDict, $author$project$Incubator$Todoist$Item$encodeItem, record.items)),
				_Utils_Tuple2(
				'projects',
				A2($author$project$Helpers$encodeIntDict, $author$project$Incubator$Todoist$Project$encodeProject, record.projects)),
				_Utils_Tuple2(
				'pendingCommands',
	...
	return $author$project$Helpers$encodeObjectWithoutNothings(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
					'activityProjectIDs',
					A2($author$project$Helpers$encodeIntDict, $author$project$ID$encode, data.activityProjectIDs)))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'taskClasses',
				A2($author$project$Helpers$encodeIntDict, $author$project$Task$Class$encodeClass, record.taskClasses)),
				_Utils_Tuple2(
				'taskInstances',
				A2($author$project$Helpers$encodeIntDict, $author$project$Task$Instance$encodeInstance, record.taskInstances)),
				_Utils_Tuple2(
				'taskEntries',
				A2($elm$json$Json$Encode$list, $author$project$Task$Entry$encodeEntry, record.taskEntries)),
				_Utils_Tuple2(
				'activities',
