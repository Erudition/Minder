...
var author$project$SmartTime$Human$Calendar$Year = function (a) {
	return {$: 'Year', a: a};
};
var author$project$SmartTime$Human$Calendar$isLeapYear = function (_n0) {
	var _int = _n0.a;
	return (!A2(elm$core$Basics$modBy, 4, _int)) && ((!A2(elm$core$Basics$modBy, 400, _int)) || (!(!A2(elm$core$Basics$modBy, 100, _int))));
};
var author$project$SmartTime$Human$Calendar$daysBeforeMonth = F2(
	function (givenYear, m) {
		var leapDays = author$project$SmartTime$Human$Calendar$isLeapYear(givenYear) ? 1 : 0;
		switch (m.$) {
			case 'Jan':
				return 0;
			case 'Feb':
...
var author$project$SmartTime$Human$Calendar$daysBeforeYear = function (_n0) {
	var givenYearInt = _n0.a;
	var y = givenYearInt - 1;
	var leapYears = (((y / 4) | 0) - ((y / 100) | 0)) + ((y / 400) | 0);
	return (365 * y) + leapYears;
};
var author$project$SmartTime$Human$Calendar$daysInMonth = F2(
	function (givenYear, m) {
		switch (m.$) {
			case 'Jan':
				return 31;
			case 'Feb':
				return author$project$SmartTime$Human$Calendar$isLeapYear(givenYear) ? 29 : 28;
			case 'Mar':
				return 31;
			case 'Apr':
				return 30;
...
var author$project$SmartTime$Human$Calendar$fromRawParts = F3(
	function (y, m, d) {
		return author$project$SmartTime$Human$Calendar$CalendarDate(
			(author$project$SmartTime$Human$Calendar$daysBeforeYear(
				author$project$SmartTime$Human$Calendar$Year(y)) + A2(
				author$project$SmartTime$Human$Calendar$daysBeforeMonth,
				author$project$SmartTime$Human$Calendar$Year(y),
				m)) + A3(
				elm$core$Basics$clamp,
				1,
				A2(
					author$project$SmartTime$Human$Calendar$daysInMonth,
					author$project$SmartTime$Human$Calendar$Year(y),
					m),
				d));
	});
...
var author$project$SmartTime$Human$Calendar$Apr = {$: 'Apr'};
var author$project$SmartTime$Human$Calendar$Aug = {$: 'Aug'};
var author$project$SmartTime$Human$Calendar$Dec = {$: 'Dec'};
var author$project$SmartTime$Human$Calendar$Feb = {$: 'Feb'};
var author$project$SmartTime$Human$Calendar$Jan = {$: 'Jan'};
var author$project$SmartTime$Human$Calendar$Jul = {$: 'Jul'};
var author$project$SmartTime$Human$Calendar$Jun = {$: 'Jun'};
var author$project$SmartTime$Human$Calendar$Mar = {$: 'Mar'};
var author$project$SmartTime$Human$Calendar$May = {$: 'May'};
var author$project$SmartTime$Human$Calendar$Nov = {$: 'Nov'};
var author$project$SmartTime$Human$Calendar$Oct = {$: 'Oct'};
var author$project$SmartTime$Human$Calendar$Sep = {$: 'Sep'};
var author$project$SmartTime$Human$Moment$importElmMonth = function (elmMonth) {
	switch (elmMonth.$) {
		case 'Jan':
			return author$project$SmartTime$Human$Calendar$Jan;
		case 'Feb':
			return author$project$SmartTime$Human$Calendar$Feb;
		case 'Mar':
			return author$project$SmartTime$Human$Calendar$Mar;
		case 'Apr':
			return author$project$SmartTime$Human$Calendar$Apr;
		case 'May':
			return author$project$SmartTime$Human$Calendar$May;
		case 'Jun':
			return author$project$SmartTime$Human$Calendar$Jun;
		case 'Jul':
			return author$project$SmartTime$Human$Calendar$Jul;
		case 'Aug':
			return author$project$SmartTime$Human$Calendar$Aug;
		case 'Sep':
			return author$project$SmartTime$Human$Calendar$Sep;
		case 'Oct':
			return author$project$SmartTime$Human$Calendar$Oct;
		case 'Nov':
			return author$project$SmartTime$Human$Calendar$Nov;
		default:
			return author$project$SmartTime$Human$Calendar$Dec;
	}
};
var author$project$SmartTime$Human$Moment$getOffsetMinutes = F2(
	function (zone, elmTime) {
		...
		var zonedDate = A3(
			author$project$SmartTime$Human$Calendar$fromRawParts,
			A2(elm$time$Time$toYear, zone, elmTime),
			author$project$SmartTime$Human$Moment$importElmMonth(
...
var author$project$SmartTime$Human$Moment$setTime = F3(
	function (time, zone, moment) {
		return _Debug_todo(
			'SmartTime.Human.Moment',
			{
				start: {line: 404, column: 5},
				end: {line: 404, column: 15}
			})('setTime');
	});
