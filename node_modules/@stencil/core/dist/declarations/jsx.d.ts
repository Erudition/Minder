...
export declare namespace JSXElements {
    ...
    interface HTMLAttributes<T = HTMLElement> extends StencilGlobalHTMLAttributes, DOMAttributes {
        innerHTML?: string;
        ref?: (elm?: T) => void;
        key?: string | number;
        accessKey?: string;
    ...
    interface SVGAttributes extends StencilGlobalHTMLAttributes, DOMAttributes {
        class?: string | {
            [className: string]: boolean;
        };
        color?: string;
