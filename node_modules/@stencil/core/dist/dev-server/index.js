...
function serve404(devServerConfig, fs, req, res) {
...
function serveFile(devServerConfig, fs, req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            if (isSimpleText(req.filePath)) {
                // easy text file, use the internal cache
                let content = yield fs.readFile(req.filePath);
...
function serveOpenInEditor(devServerConfig, fs, req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        let status = 200;
        const data = {};
        try {
            if (devServerConfig.editors.length > 0) {
                yield parseData(devServerConfig, fs, req, data);
...
function parseData(devServerConfig, fs, req, data) {
    return __awaiter(this, void 0, void 0, function* () {
...
function serveDevClient(devServerConfig, fs, req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            try {
                req.stats = yield fs.stat(req.filePath);
...
function serveDevClientScript(devServerConfig, fs, res) {
    return __awaiter(this, void 0, void 0, function* () {
...
function serveDirectoryIndex(devServerConfig, fs, req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const indexFilePath = path.join(req.filePath, 'index.html');
            req.stats = yield fs.stat(indexFilePath);
            if (req.stats.isFile()) {
        ...
        try {
            const dirItemNames = yield fs.readdir(req.filePath);
            try {
                const dirTemplatePath = path.join(devServerConfig.devServerDir, 'templates', 'directory-index.html');
                const dirTemplate = yield fs.readFile(dirTemplatePath);
                const files = yield getFiles(fs, req.filePath, req.pathname, dirItemNames);
...
function getFiles(fs, filePath, urlPathName, dirItemNames) {
    return __awaiter(this, void 0, void 0, function* () {
        const items = yield getDirectoryItems(fs, filePath, urlPathName, dirItemNames);
        if (urlPathName !== '/') {
            items.unshift({
                isDirectory: true,
                pathname: '../',
...
function getDirectoryItems(fs, filePath, urlPathName, dirItemNames) {
    return __awaiter(this, void 0, void 0, function* () {
        const items = yield Promise.all(dirItemNames.map((dirItemName) => __awaiter(this, void 0, void 0, function* () {
            ...
            const stats = yield fs.stat(absPath);
            const item = {
                name: dirItemName,
...
function createHttpServer(devServerConfig, fs, destroys) {
    return __awaiter(this, void 0, void 0, function* () {
...
function startDevServerWorker(process, devServerConfig, fs) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const destroys = [];
            devServerConfig.editors = yield getEditors();
            // create the http server listening for and responding to requests from the browser
            let httpServer = yield createHttpServer(devServerConfig, fs, destroys);
...
function startServer(devServerConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const fs = new NodeFs();
            devServerConfig.contentTypes = yield loadContentTypes(fs);
...
function loadContentTypes(fs) {
    return __awaiter(this, void 0, void 0, function* () {
        const contentTypePath = path.join(__dirname, 'content-type-db.json');
        const contentTypeJson = yield fs.readFile(contentTypePath);
