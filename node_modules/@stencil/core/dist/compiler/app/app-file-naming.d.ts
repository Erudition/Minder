...
export declare function getDistCjsDir(config: d.Config, outputTarget: d.OutputTargetDist, sourceTarget?: d.SourceTarget): string;
...
export declare function getDefineCustomElementsCjsPath(config: d.Config, outputTarget: d.OutputTargetDist, sourceTarget: d.SourceTarget): string;
