...
describe('publisher', () => {
    it('create', () => {
        const p = new publisher_1.Publisher('devapp', 'conference-app', 8100);
    ...
    it('start/stop', () => __awaiter(this, void 0, void 0, function* () {
        const p = new publisher_1.Publisher('devapp', 'conference-app', 8100);
        yield p.start();
...
it('prepareInterfaces', () => {
    ...
    const output = publisher_1.prepareInterfaces({
