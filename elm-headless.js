	...
	return author$project$Porting$encodeObjectWithoutNothings(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
					'channel',
					elm$json$Json$Encode$string(v.channel))),
				author$project$Porting$omittable(
...
var author$project$Activity$Reminder$reminderBase = function () {
	var blank = author$project$NativeScript$Notification$blank('Override me!');
	return _Utils_update(
		blank,
		{
...
var author$project$Main$update = F2(
	function (msg, model) {
		...
		switch (msg.$) {
			...
			case 'TodoistServerResponse':
				var response = msg.a;
				var blank = author$project$NativeScript$Notification$blank('Sync Status');
