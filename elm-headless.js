...
{
	if (region.b6.a7 === region.cA.a7)
	{
		return 'on line ' + region.b6.a7;
	}
	return 'on lines ' + region.b6.a7 + ' through ' + region.cA.a7;
}
													...
													return function (relevanceStarts) {
														return function (relevanceEnds) {
															return function (importance) {
																return {dE: activity, bJ: completion, dP: deadline, a5: history, cJ: id, d2: importance, d9: maxEffort, c_: minEffort, bY: parent, b_: plannedFinish, b$: plannedStart, b0: predictedEffort, b2: relevanceEnds, b3: relevanceStarts, ex: tags, aw: title};
															};
														};
													};
												};
...
var author$project$SmartTime$Human$Moment$getOffset = F2(
	function (referencePoint, zone) {
		return A3(author$project$SmartTime$Human$Moment$searchRemainingZoneHistory, referencePoint, zone.a3, zone.a5);
	});
...
var author$project$SmartTime$Human$Moment$utc = {
	a3: author$project$SmartTime$Duration$fromMinutes(0),
	a5: _List_Nil,
	bt: 'Universal'
};
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'history',
				A2(elm$json$Json$Encode$list, author$project$Task$Task$encodeHistoryEntry, record.a5)),
				_Utils_Tuple2(
				'parent',
...
var author$project$Incubator$Todoist$Command$encodeNewItem = function (_new) {
	return author$project$Porting$encodeObjectWithoutNothings(
		_List_fromArray(
			[
				author$project$Porting$omittable(
				_Utils_Tuple3('temp_id', elm$json$Json$Encode$string, _new.aW)),
				author$project$Porting$normal(
				_Utils_Tuple2(
					'content',
		...
		switch (msg.$) {
			...
			case 6:
				...
				var maybeTaskTitle = A2(
					...
					A2(elm_community$intdict$IntDict$get, id, app.ey));
				return _Utils_Tuple3(
					state,
					_Utils_update(
						app,
							...
							[
								...
								A2(
									...
									_List_fromArray(
										[
											_Utils_Tuple2(
											author$project$SmartTime$Human$Moment$toStandardString(env.dv),
		...
		var normalizedEntry = function (_n0) {
			...
			return _Utils_Tuple2(
				...
				A2(
					...
					id,
					author$project$Task$Progress$maximize(task.bJ)));
		};
		var tasksWithNames = A2(
			elm$core$List$map,
			normalizedEntry,
			elm_community$intdict$IntDict$toList(app.ey));
			...
			return _List_fromArray(
				[
					...
					A2(
						author$project$TaskList$UpdateProgress,
						next.cJ,
						author$project$Task$Progress$maximize(next.bJ)))
				]);
		};
...
var author$project$Main$handleUrlTriggers = F2(
	function (rawUrl, model) {
		...
		if (!_n14.$) {
			...
			var _n15 = _Utils_Tuple2(parsedUrlSuccessfully, normalizedUrl.ek);
			if (!_n15.a.$) {
				if (!_n15.b.$) {
...
var author$project$SmartTime$Human$Moment$makeZone = F3(
	function (elmZoneName, elmZone, now) {
		...
		if (!elmZoneName.$) {
			...
			return {a3: deducedOffset, a5: _List_Nil, bt: zoneName};
		} else {
			var offsetMinutes = elmZoneName.a;
			return {
				a3: author$project$SmartTime$Duration$fromMinutes(offsetMinutes),
				a5: _List_Nil,
				bt: 'Unsupported'
			};
		}
