...
{
	if (region.b6.a6 === region.cA.a6)
	{
		return 'on line ' + region.b6.a6;
	}
	return 'on lines ' + region.b6.a6 + ' through ' + region.cA.a6;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		function done(response) {
			callback(toTask(request.dW.a(response)));
		}

		var xhr = new XMLHttpRequest();
		xhr.addEventListener('error', function() { done(elm$http$Http$NetworkError_); });
		xhr.addEventListener('timeout', function() { done(elm$http$Http$Timeout_); });
		xhr.addEventListener('load', function() { done(_Http_toResponse(request.dW.b, xhr)); });
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { b: 'hidden', dM: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { b: 'mozHidden', dM: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { b: 'msHidden', dM: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { b: 'webkitHidden', dM: 'webkitvisibilitychange' }
		: { b: 'hidden', dM: 'visibilitychange' };
}
...
var author$project$Headless$fallbackUrl = {dZ: elm$core$Maybe$Nothing, d$: 'headless.docket.com', ef: '', eh: elm$core$Maybe$Nothing, ej: 0, ek: elm$core$Maybe$Nothing};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {dZ: fragment, d$: host, ef: path, eh: port_, ej: protocol, ek: query};
	});
...
var author$project$Headless$headlessSubscriptions = function (model) {
	var appData = model.dI;
	var environment = model.dT;
...
var author$project$Incubator$Todoist$emptyCache = {O: elm_community$intdict$IntDict$empty, aq: '*', bx: _List_Nil, S: elm_community$intdict$IntDict$empty};
var author$project$AppData$emptyTodoistIntegrationData = {bG: elm_community$intdict$IntDict$empty, bI: author$project$Incubator$Todoist$emptyCache, bZ: elm$core$Maybe$Nothing};
var author$project$AppData$fromScratch = {bg: elm_community$intdict$IntDict$empty, ak: _List_Nil, ey: elm_community$intdict$IntDict$empty, b9: _List_Nil, ca: author$project$AppData$emptyTodoistIntegrationData, cb: 0};
							...
							return function (maxTime) {
								return function (hidden) {
									return function (template) {
										return function (id) {
											return {d: backgroundable, e: category, f: evidence, a: excusable, b: hidden, g: icon, cJ: id, h: maxTime, c: names, i: taskOptional, j: template};
										};
									};
								};
							};
...
var author$project$SmartTime$Duration$breakdown = function (duration) {
	...
	return {cz: days, cI: hours, cZ: withoutSeconds, c$: minutes, dj: seconds};
};
					...
					return _Utils_Tuple2(
						...
						elm$core$Result$Ok(
							_Utils_Tuple3(
								...
								A2(elm$core$List$cons, res.W, valAcc))));
				}
			}
		});
	return function (json) {
				...
				return elm_community$intdict$IntDict$Inner(
					{
						...
						s: p,
						p: r,
						b5: elm_community$intdict$IntDict$size(l) + elm_community$intdict$IntDict$size(r)
					});
			}
		}
	});
...
var elm_community$intdict$IntDict$lcp = F2(
	function (x, y) {
		...
		return {aC: branchingBit, R: prefixBits};
	});
...
var elm_community$intdict$IntDict$update = F3(
	function (key, alter, dict) {
		...
		switch (dict.$) {
			...
			case 1:
				var l = dict.a;
				return _Utils_eq(l.cX, key) ? alteredNode(
					elm$core$Maybe$Just(l.W)) : A2(
					join,
					_Utils_Tuple2(
						key,
						alteredNode(elm$core$Maybe$Nothing)),
					_Utils_Tuple2(l.cX, dict));
			default:
				var i = dict.a;
															...
															return function (is_deleted) {
																return function (is_archived) {
																	return function (date_added) {
																		return {ci: assigned_by_uid, cu: checked, Z: child_order, cv: children, aE: collapsed, bk: content, cx: date_added, bl: day_order, aG: due, cJ: id, cL: in_history, cR: is_archived, bO: is_deleted, bw: parent_id, by: priority, c7: project_id, dh: responsible_uid, dA: user_id};
																	};
																};
															};
														};
...
var author$project$Incubator$Todoist$Item$Due = F5(
	function (date, timezone, string, lang, isRecurring) {
		return {cw: date, cQ: isRecurring, cY: lang, dp: string, dw: timezone};
	});
									...
									return function (is_favorite) {
										return function (inbox_project) {
											return function (team_inbox) {
												return {Z: child_order, aE: collapsed, bj: color, cJ: id, cM: inbox_project, cR: is_archived, bO: is_deleted, bq: is_favorite, bt: name, bw: parent_id, dl: shared, dt: team_inbox};
											};
										};
									};
								};
													...
													return function (relevanceStarts) {
														return function (relevanceEnds) {
															return function (importance) {
																return {dE: activity, bJ: completion, dP: deadline, a4: history, cJ: id, d2: importance, d9: maxEffort, c_: minEffort, bY: parent, b_: plannedFinish, b$: plannedStart, b0: predictedEffort, b2: relevanceEnds, b3: relevanceStarts, ex: tags, aw: title};
															};
														};
													};
												};
...
var author$project$ParserExtra$deadEndToString = function (deadend) {
	return author$project$ParserExtra$problemToString(deadend.ei) + (' at row ' + (elm$core$String$fromInt(deadend.eo) + (', col ' + elm$core$String$fromInt(deadend.dN))));
};
...
var elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {dN: col, dO: contextStack, ei: problem, eo: row};
	});
...
var elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4(elm$parser$Parser$Advanced$DeadEnd, s.eo, s.dN, x, s.r));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{dN: col, r: s0.r, u: s0.u, l: offset, eo: row, k: s0.k});
			} else {
...
var elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5(elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.l, s.eo, s.dN, s);
	};
};
...
var elm$parser$Parser$Advanced$token = function (_n0) {
	...
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$isSubString, str, s.l, s.eo, s.dN, s.k);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{dN: newCol, r: s.r, u: s.u, l: newOffset, eo: newRow, k: s.k});
	};
};
...
var elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {dN: col, ei: problem, eo: row};
	});
var elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3(elm$parser$Parser$DeadEnd, p.eo, p.dN, p.ei);
};
...
var elm$parser$Parser$Advanced$run = F2(
	function (_n0, src) {
		var parse = _n0;
		var _n1 = parse(
			{dN: 1, r: _List_Nil, u: 1, l: 0, eo: 1, k: src});
		if (!_n1.$) {
			var value = _n1.b;
...
var elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {dN: s.dN + (newOffset - s.l), r: s.r, u: s.u, l: newOffset, eo: s.eo, k: s.k};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				elm$parser$Parser$Advanced$Bad,
				true,
				A4(elm$parser$Parser$Advanced$fromInfo, s.eo, s.dN - (floatOffset + s.l), invalid, s.r));
		} else {
		...
		return elm$parser$Parser$Advanced$number(
			{
				...
				cP: elm$core$Result$Ok(elm$core$Basics$toFloat),
				d5: invalid,
...
var author$project$SmartTime$Human$Moment$getOffset = F2(
	function (referencePoint, zone) {
		return A3(author$project$SmartTime$Human$Moment$searchRemainingZoneHistory, referencePoint, zone.a2, zone.a4);
	});
...
var author$project$SmartTime$Human$Moment$utc = {
	a2: author$project$SmartTime$Duration$fromMinutes(0),
	a4: _List_Nil,
	bt: 'Universal'
};
	...
	function (_n0, val) {
		...
		if (_n1.$ === 1) {
			...
			if (_n2.$ === 1) {
				...
				if (!_n3.b) {
					return zwilias$json_decode_exploration$Json$Decode$Exploration$Success(acc.W);
				} else {
					var x = _n3.a;
					var xs = _n3.b;
					return A2(
...
var author$project$Environment$preInit = function (maybeKey) {
	return {c2: maybeKey, dv: author$project$SmartTime$Moment$zero, ez: author$project$SmartTime$Human$Moment$utc};
};
...
var author$project$Main$bypassFakeFragment = function (url) {
	var _n0 = A2(elm$core$Maybe$map, elm$core$String$uncons, url.dZ);
...
var elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {am: frag, ar: params, ah: unvisited, W: value, ax: visited};
	});
		...
		return elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					...
					elm$url$Url$Parser$prepareQuery(url.ek),
					url.dZ,
...
var author$project$Main$buildModel = F3(
	function (appData, url, maybeKey) {
		return {
			dI: appData,
			dT: author$project$Environment$preInit(maybeKey),
	...
	return author$project$Porting$encodeObjectWithoutNothings(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
					'stock',
					author$project$ID$encode(record.cJ))),
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'date',
				elm$json$Json$Encode$string(record.cw)),
				_Utils_Tuple2(
				'timezone',
				A2(elm_community$json_extra$Json$Encode$Extra$maybe, elm$json$Json$Encode$string, record.dw)),
				_Utils_Tuple2(
				'string',
				...
				_Utils_Tuple2(
				'is_recurring',
				elm$json$Json$Encode$bool(record.cQ))
			]));
};
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				elm$json$Json$Encode$int(record.cJ)),
				_Utils_Tuple2(
				'user_id',
				elm$json$Json$Encode$int(record.dA)),
				_Utils_Tuple2(
				'project_id',
				elm$json$Json$Encode$int(record.c7)),
				_Utils_Tuple2(
				'content',
				elm$json$Json$Encode$string(record.bk)),
				_Utils_Tuple2(
				'due',
				A2(elm_community$json_extra$Json$Encode$Extra$maybe, author$project$Incubator$Todoist$Item$encodeDue, record.aG)),
				_Utils_Tuple2(
				'priority',
				author$project$Incubator$Todoist$Item$encodePriority(record.by)),
				_Utils_Tuple2(
				'parent_id',
				A2(elm_community$json_extra$Json$Encode$Extra$maybe, elm$json$Json$Encode$int, record.bw)),
				_Utils_Tuple2(
				'child_order',
				elm$json$Json$Encode$int(record.Z)),
				_Utils_Tuple2(
				'day_order',
				elm$json$Json$Encode$int(record.bl)),
				_Utils_Tuple2(
				'collapsed',
				author$project$Porting$encodeBoolToInt(record.aE)),
				_Utils_Tuple2(
				'children',
				A2(elm$json$Json$Encode$list, elm$json$Json$Encode$int, record.cv)),
				_Utils_Tuple2(
				'assigned_by_uid',
				elm$json$Json$Encode$int(record.ci)),
				_Utils_Tuple2(
				'responsible_uid',
				A2(elm_community$json_extra$Json$Encode$Extra$maybe, elm$json$Json$Encode$int, record.dh)),
				_Utils_Tuple2(
				'checked',
				author$project$Porting$encodeBoolToInt(record.cu)),
				_Utils_Tuple2(
				'in_history',
				author$project$Porting$encodeBoolToInt(record.cL)),
				_Utils_Tuple2(
				'is_deleted',
				author$project$Porting$encodeBoolToInt(record.bO)),
				_Utils_Tuple2(
				'is_archived',
				author$project$Porting$encodeBoolToInt(record.cR)),
				_Utils_Tuple2(
				'date_added',
				elm$json$Json$Encode$string(record.cx))
			]));
};
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'name',
				elm$json$Json$Encode$string(record.bt)),
				_Utils_Tuple2(
				'color',
				elm$json$Json$Encode$int(record.bj)),
				_Utils_Tuple2(
				'parent_id',
				A2(elm_community$json_extra$Json$Encode$Extra$maybe, elm$json$Json$Encode$int, record.bw)),
				_Utils_Tuple2(
				...
				_Utils_Tuple2(
				'collapsed',
				elm$json$Json$Encode$int(record.aE)),
				_Utils_Tuple2(
				'shared',
				elm$json$Json$Encode$bool(record.dl)),
				_Utils_Tuple2(
				'is_deleted',
				author$project$Porting$encodeBoolToInt(record.bO)),
				_Utils_Tuple2(
				...
				_Utils_Tuple2(
				'inbox_project',
				elm$json$Json$Encode$bool(record.cM)),
				_Utils_Tuple2(
				'team_inbox',
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'pendingCommands',
				A2(elm$json$Json$Encode$list, elm$json$Json$Encode$string, record.bx))
			]));
};
	...
	return author$project$Porting$encodeObjectWithoutNothings(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
					'cache',
					author$project$Incubator$Todoist$encodeCache(data.bI))),
				author$project$Porting$omittable(
				_Utils_Tuple3('parentProjectID', elm$json$Json$Encode$int, data.bZ)),
				author$project$Porting$normal(
				_Utils_Tuple2(
					'activityProjectIDs',
...
var author$project$SmartTime$Human$Calendar$toOrdinalDate = function (_n0) {
	...
	return {
		bW: rd - author$project$SmartTime$Human$Calendar$Year$daysBefore(givenYear),
		t: givenYear
	};
};
var author$project$SmartTime$Human$Calendar$toParts = function (_n0) {
	...
	return A3(author$project$SmartTime$Human$Calendar$calculate, date.t, 0, date.bW);
};
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'title',
				elm$json$Json$Encode$string(record.aw)),
				_Utils_Tuple2(
				'completion',
				author$project$Task$Progress$encodeProgress(record.bJ)),
				_Utils_Tuple2(
				'id',
				elm$json$Json$Encode$int(record.cJ)),
				_Utils_Tuple2(
				'minEffort',
				author$project$Porting$encodeDuration(record.c_)),
				_Utils_Tuple2(
				'predictedEffort',
				author$project$Porting$encodeDuration(record.b0)),
				_Utils_Tuple2(
				'maxEffort',
				author$project$Porting$encodeDuration(record.d9)),
				_Utils_Tuple2(
				'history',
				A2(elm$json$Json$Encode$list, author$project$Task$Task$encodeHistoryEntry, record.a4)),
				_Utils_Tuple2(
				'parent',
				...
				_Utils_Tuple2(
				'activity',
				A2(elm_community$json_extra$Json$Encode$Extra$maybe, author$project$ID$encode, record.dE)),
				_Utils_Tuple2(
				'deadline',
				A2(elm_community$json_extra$Json$Encode$Extra$maybe, author$project$Task$Task$encodeTaskMoment, record.dP)),
				_Utils_Tuple2(
				'plannedStart',
				A2(elm_community$json_extra$Json$Encode$Extra$maybe, author$project$Task$Task$encodeTaskMoment, record.b$)),
				_Utils_Tuple2(
				'plannedFinish',
				A2(elm_community$json_extra$Json$Encode$Extra$maybe, author$project$Task$Task$encodeTaskMoment, record.b_)),
				_Utils_Tuple2(
				'relevanceStarts',
				A2(elm_community$json_extra$Json$Encode$Extra$maybe, author$project$Task$Task$encodeTaskMoment, record.b3)),
				_Utils_Tuple2(
				'relevanceEnds',
				A2(elm_community$json_extra$Json$Encode$Extra$maybe, author$project$Task$Task$encodeTaskMoment, record.b2)),
				_Utils_Tuple2(
				'importance',
				elm$json$Json$Encode$float(record.d2))
			]));
};
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'uid',
				elm$json$Json$Encode$int(record.cb)),
				_Utils_Tuple2(
				'errors',
				A2(
					elm$json$Json$Encode$list,
				...
				_Utils_Tuple2(
				'timeline',
				A2(elm$json$Json$Encode$list, author$project$Activity$Activity$encodeSwitch, record.b9)),
				_Utils_Tuple2(
				'todoist',
				author$project$AppData$encodeTodoistIntegrationData(record.ca))
			]));
};
...
var author$project$Incubator$Todoist$Response = F5(
	function (sync_token, sync_status, full_sync, items, projects) {
		return {cG: full_sync, O: items, S: projects, ew: sync_status, dr: sync_token};
	});
var author$project$Incubator$Todoist$Command$CommandError = F2(
	function (error_code, error) {
		return {dU: error, dV: error_code};
	});
	...
	return author$project$Porting$encodeObjectWithoutNothings(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
					'id',
					author$project$Incubator$Todoist$Command$encodeItemID(item.cJ))),
				author$project$Porting$omittable(
				_Utils_Tuple3('content', elm$json$Json$Encode$string, item.bk)),
				author$project$Porting$omittable(
				_Utils_Tuple3('due', author$project$Incubator$Todoist$Item$encodeDue, item.aG)),
				author$project$Porting$omittable(
				_Utils_Tuple3('priority', author$project$Incubator$Todoist$Item$encodePriority, item.by)),
				author$project$Porting$omittable(
				_Utils_Tuple3('day_order', elm$json$Json$Encode$int, item.bl)),
				author$project$Porting$omittable(
				_Utils_Tuple3('collapsed', author$project$Porting$encodeBoolToInt, item.aE))
			]));
};
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
					...
					author$project$Incubator$Todoist$Command$encodeItemID(item.cJ))),
				author$project$Porting$omittable(
				_Utils_Tuple3('date_completed', elm$json$Json$Encode$string, item.cy)),
				author$project$Porting$normal(
				_Utils_Tuple2(
					'force_history',
					elm$json$Json$Encode$bool(item.cF)))
			]));
};
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				elm$json$Json$Encode$int(order.cJ)),
				_Utils_Tuple2(
				'child_order',
				elm$json$Json$Encode$int(order.Z))
			]));
};
...
var author$project$Incubator$Todoist$Command$encodeNewItem = function (_new) {
	return author$project$Porting$encodeObjectWithoutNothings(
		_List_fromArray(
			[
				author$project$Porting$omittable(
				_Utils_Tuple3('temp_id', elm$json$Json$Encode$string, _new.aV)),
				author$project$Porting$normal(
				_Utils_Tuple2(
					'content',
					elm$json$Json$Encode$string(_new.bk))),
				author$project$Porting$omittable(
				_Utils_Tuple3('project_id', author$project$Incubator$Todoist$Command$encodeProjectID, _new.c7)),
				author$project$Porting$omittable(
				_Utils_Tuple3('due', author$project$Incubator$Todoist$Item$encodeDue, _new.aG)),
				author$project$Porting$normal(
				_Utils_Tuple2(
					'priority',
					author$project$Incubator$Todoist$Item$encodePriority(_new.by))),
				author$project$Porting$omittable(
				_Utils_Tuple3('parent_id', author$project$Incubator$Todoist$Command$encodeItemID, _new.bw)),
				author$project$Porting$omittable(
				_Utils_Tuple3('child_order', elm$json$Json$Encode$int, _new.Z)),
				author$project$Porting$omittable(
				_Utils_Tuple3('day_order', elm$json$Json$Encode$int, _new.bl)),
				author$project$Porting$omittable(
				_Utils_Tuple3('collapsed', author$project$Porting$encodeBoolToInt, _new.aE)),
				author$project$Porting$omittable(
				_Utils_Tuple3('auto_reminder', elm$json$Json$Encode$bool, _new.cj))
			]));
};
	...
	return author$project$Porting$encodeObjectWithoutNothings(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
					'name',
					elm$json$Json$Encode$string(_new.bt))),
				author$project$Porting$omittable(
				_Utils_Tuple3('color', elm$json$Json$Encode$int, _new.bj)),
				author$project$Porting$omittable(
				_Utils_Tuple3('parent_id', elm$json$Json$Encode$int, _new.bw)),
				author$project$Porting$omittable(
				_Utils_Tuple3('child_order', elm$json$Json$Encode$int, _new.Z)),
				author$project$Porting$normal(
				_Utils_Tuple2(
					'is_favorite',
					elm$json$Json$Encode$bool(_new.bq)))
			]));
};
	...
	return author$project$Porting$encodeObjectWithoutNothings(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
					'color',
					elm$json$Json$Encode$int(_new.bj))),
				author$project$Porting$normal(
				_Utils_Tuple2(
					'collapsed',
					elm$json$Json$Encode$bool(_new.aE))),
				author$project$Porting$normal(
				_Utils_Tuple2(
					'is_favorite',
					elm$json$Json$Encode$bool(_new.bq)))
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				elm$json$Json$Encode$int(v.cJ)),
				_Utils_Tuple2(
				'child_order',
				elm$json$Json$Encode$int(v.Z))
			]));
};
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
					...
					author$project$Incubator$Todoist$Command$encodeItemID(item.cJ))),
				author$project$Porting$omittable(
				_Utils_Tuple3('due', elm$json$Json$Encode$string, item.aG))
			]));
};
			...
			return elm$http$Http$Request(
				{
					az: r.az,
					dL: r.dL,
					dW: A2(_Http_mapExpect, func, r.dW),
					H: r.H,
					K: r.K,
					L: r.L,
					N: r.N,
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{az: false, dL: r.dL, dW: r.dW, H: r.H, K: r.K, L: r.L, N: r.N, eC: r.eC}));
};
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{dL: r.dL, dW: r.dW, H: _List_Nil, K: 'POST', L: elm$core$Maybe$Nothing, N: elm$core$Maybe$Nothing, eC: r.eC});
};
		...
		return elm$http$Http$post(
			{
				...
				eC: A4(author$project$Incubator$Todoist$serverUrl, secret, resourceList, commandList, cache.aq)
			});
	});
	...
	function (key, dict) {
		...
		while (true) {
			switch (dict.$) {
				...
				case 1:
					var l = dict.a;
					return _Utils_eq(l.cX, key) ? elm$core$Maybe$Just(l.W) : elm$core$Maybe$Nothing;
				default:
					var i = dict.a;
...
var author$project$Incubator$Todoist$summarizeChanges = F2(
	function (oldCache, _new) {
		...
		return {cT: newlyAddedItemIDs, cU: remainingItemIDs, cV: deletedItemIDs, c8: newlyAddedProjectIDs, c9: remainingProjectIDs, da: deletedProjectIDs};
	});
...
var elm_community$intdict$IntDict$determineBranchRelation = F2(
	function (l, r) {
		...
		var mask = elm_community$intdict$IntDict$highestBitSet(
			A2(elm_community$intdict$IntDict$mostSignificantBranchingBit, lp.aC, rp.aC));
	...
	function (_n0, oldCache) {
		...
		if (!response.$) {
			...
			var prune = function (inputDict) {
				return (!newStuff.cG) ? author$project$Incubator$Todoist$pruneDeleted(inputDict) : inputDict;
			};
			var _n2 = _Utils_Tuple2(
				elm_community$intdict$IntDict$fromList(
					A2(
				...
				_Utils_Tuple2(
					{
						...
						aq: A2(elm$core$Maybe$withDefault, oldCache.aq, newStuff.dr),
						bx: _List_Nil,
						S: prune(
...
var author$project$Integrations$Todoist$describeSuccess = function (report) {
	var _n0 = _Utils_Tuple3(
		elm$core$Set$size(report.c8),
		elm$core$Set$size(report.da),
		elm$core$Set$size(report.c9));
	...
	var _n1 = _Utils_Tuple3(
		elm$core$Set$size(report.cT),
		elm$core$Set$size(report.cV),
		elm$core$Set$size(report.cU));
...
var author$project$Integrations$Todoist$detectActivityProjects = F3(
	function (maybeParent, app, cache) {
		if (maybeParent.$ === 1) {
			...
			var oldActivityLookupTable = app.ca.bG;
...
var author$project$Task$Task$newTask = F2(
	function (description, id) {
		return {
			...
			bJ: _Utils_Tuple2(0, author$project$Task$Progress$Percent),
			dP: elm$core$Maybe$Nothing,
			a4: _List_Nil,
			cJ: id,
			d2: 0,
			d9: author$project$SmartTime$Duration$zero,
			c_: author$project$SmartTime$Duration$zero,
			bY: elm$core$Maybe$Nothing,
			b_: elm$core$Maybe$Nothing,
			b$: elm$core$Maybe$Nothing,
			b0: author$project$SmartTime$Duration$zero,
...
var author$project$Integrations$Todoist$itemToTask = F2(
	function (activityID, item) {
		var getDueDate = function (due) {
			return author$project$Incubator$Todoist$Item$fromRFC3339Date(due.cw);
		};
		var _n0 = author$project$Integrations$Todoist$extractTiming2(item.bk);
		var newName = _n0.a;
		var _n1 = _n0.b;
		var minDur = _n1.a;
		var maxDur = _n1.b;
		var base = A2(author$project$Task$Task$newTask, newName, item.cJ);
		return _Utils_update(
			base,
			{
				dE: elm$core$Maybe$Just(activityID),
				bJ: item.cu ? author$project$Task$Progress$maximize(base.bJ) : base.bJ,
				dP: A2(elm$core$Maybe$andThen, getDueDate, item.aG),
				d2: author$project$Integrations$Todoist$calcImportance(item),
				d9: A2(elm$core$Maybe$withDefault, base.d9, maxDur),
				c_: A2(elm$core$Maybe$withDefault, base.c_, minDur),
				ex: _List_Nil
			});
	});
var author$project$Integrations$Todoist$timetrackItemToTask = F2(
	function (lookup, item) {
		var _n0 = A2(elm_community$intdict$IntDict$get, item.c7, lookup);
		if (!_n0.$) {
			var act = _n0.a;
			return elm$core$Maybe$Just(
...
var author$project$Integrations$Todoist$handle = F2(
	function (msg, app) {
		var _n0 = A2(author$project$Incubator$Todoist$handleResponse, msg, app.ca.bI);
		if (!_n0.$) {
			var _n1 = _n0.a;
			var newCache = _n1.a;
			var changes = _n1.b;
			var newMaybeParent = A2(author$project$Integrations$Todoist$tryGetTimetrackParentProject, app.ca, newCache);
			var projectToActivityMapping = A3(author$project$Integrations$Todoist$detectActivityProjects, newMaybeParent, app, newCache);
			var newTodoistData = {bG: projectToActivityMapping, bI: newCache, bZ: newMaybeParent};
...
var author$project$Main$Model = F3(
	function (viewState, appData, environment) {
		return {dI: appData, dT: environment, be: viewState};
	});
						...
						_Utils_update(
							app,
							{
								ey: A3(
									...
									author$project$SmartTime$Moment$toSmartInt(env.dv),
									A2(
...
var author$project$Activity$Switching$currentActivityFromApp = function (app) {
	return author$project$Activity$Activity$currentActivityID(app.b9);
};
...
var author$project$Activity$Measure$exportLastSession = F2(
	function (app, old) {
		var timeSpent = A2(
			...
			elm$core$List$head(
				A2(author$project$Activity$Measure$sessions, app.b9, old)));
		return elm$core$String$fromInt(
...
var author$project$Activity$Switching$switchPopup = F4(
	function (timeline, env, newKV, _n0) {
		...
		return timeSpentString(timeSpentLastSession) + (' spent on ' + (author$project$Activity$Activity$getName(old) + ('\n' + (author$project$Activity$Activity$getName(old) + (' ➤ ' + (author$project$Activity$Activity$getName(_new) + ('\n' + ('Starting from ' + timeSpentString(
			A3(author$project$Activity$Measure$excusedUsage, timeline, env.dv, newKV))))))))));
	});
...
var author$project$Task$Task$compareSoonness = F3(
	function (zone, taskA, taskB) {
		var _n0 = _Utils_Tuple2(taskA.dP, taskB.dP);
		if (!_n0.a.$) {
			if (!_n0.b.$) {
	...
	function (activityID, app, env) {
		...
		if (_n0.$ === 1) {
			...
			if (_n1.$ === 1) {
				...
				return _Utils_eq(nextActivity, activityID) ? author$project$Activity$Activity$OnTask(nextTask.d9) : author$project$Activity$Activity$OffTask(excusedLeft);
			}
		}
	});
...
var author$project$Activity$Reminder$scheduleExcusedReminders = F2(
	function (now, timeLeft) {
		var yetToPass = function (reminder) {
			return !A2(author$project$SmartTime$Moment$compare, reminder.ag, now);
		};
		...
		return (!author$project$SmartTime$Duration$isZero(timeLeft)) ? A2(
			...
			_List_fromArray(
				[
					{
					aj: _List_Nil,
					ag: A2(author$project$SmartTime$Moment$future, now, halfLeft),
					at: 'Ready for you to get back on task',
					aw: write(halfLeft) + ' left'
				},
					{
					aj: _List_Nil,
					ag: A2(author$project$SmartTime$Moment$future, now, thirdLeft),
					at: 'Save some excused time for when you really need it!',
					aw: 'Excused for ' + (write(thirdLeft) + ' more')
				},
					{
					aj: _List_Nil,
					ag: A2(author$project$SmartTime$Moment$future, now, quarterLeft),
					at: 'Don\'t wait to get back on task',
					aw: 'Excused for ' + (write(quarterLeft) + ' more')
				},
					{
					aj: _List_Nil,
					ag: A2(author$project$SmartTime$Moment$future, now, fifthLeft),
					at: 'Can you finish this later?',
					aw: 'Excused for ' + (write(fifthLeft) + ' more')
				},
					{
					aj: _List_Nil,
					ag: A2(
						...
						author$project$SmartTime$Human$Duration$dur(
							author$project$SmartTime$Human$Duration$Minutes(5))),
					at: 'Can you get back on task now?',
					aw: '5 minutes left!'
				},
					{
					aj: _List_Nil,
					...
					at: 'Stop now. You can come back to this later.',
					aw: '1 minute left!'
				}
				])) : _List_Nil;
	});
...
var author$project$Activity$Reminder$Reminder = F4(
	function (scheduledFor, title, subtitle, actions) {
		return {aj: actions, ag: scheduledFor, at: subtitle, aw: title};
	});
	...
	function (env, timeline, onTaskStatus, _n0) {
		...
		switch (onTaskStatus.$) {
			case 0:
				...
				return A2(author$project$Activity$Switching$scheduleOnTaskReminders, env.dv, timeLeft);
			case 1:
				var excusedLeft = onTaskStatus.a;
				return author$project$SmartTime$Duration$isPositive(excusedLeft) ? A2(author$project$Activity$Reminder$scheduleExcusedReminders, env.dv, excusedLeft) : author$project$Activity$Switching$scheduleOffTaskReminders(env.dv);
			default:
				return _List_Nil;
		}
	});
	...
	return elm$core$String$concat(
		A2(
			...
			_List_fromArray(
				[
					elm$core$String$fromInt(
					author$project$SmartTime$Moment$toUnixTimeInt(reminder.ag)),
					reminder.aw,
					reminder.at
				])));
};
	...
	function (activityID, app, env) {
		var updatedApp = _Utils_update(
			app,
			{
				b9: A2(
					elm$core$List$cons,
					A2(author$project$Activity$Activity$Switch, env.dv, activityID),
					app.b9)
			});
...
var author$project$Main$handleUrlTriggers = F2(
	function (rawUrl, model) {
		...
		if (!_n13.$) {
			...
			var _n14 = _Utils_Tuple2(parsedUrlSuccessfully, normalizedUrl.ek);
			if (!_n14.a.$) {
				if (!_n14.b.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								dI: A2(author$project$AppData$saveError, appData, problemText)
							}),
...
var author$project$Main$update = F2(
	function (msg, model) {
		...
		var _n0 = _Utils_Tuple2(msg, viewState.a8);
		_n0$7:
		while (true) {
			switch (_n0.a.$) {
				case 4:
				...
				case 5:
					...
					return justRunCommand(
						A2(
							...
							author$project$Integrations$Todoist$fetchUpdates(appData.ca)));
				case 6:
			...
			elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						author$project$Main$appDataToJson(newModel.dI)),
						cmds
					])));
	});
...
var author$project$SmartTime$Human$Moment$makeZone = F3(
	function (elmZoneName, elmZone, now) {
		...
		if (!elmZoneName.$) {
			...
			return {a2: deducedOffset, a4: _List_Nil, bt: zoneName};
		} else {
			var offsetMinutes = elmZoneName.a;
			return {
				a2: author$project$SmartTime$Duration$fromMinutes(offsetMinutes),
				a4: _List_Nil,
				bt: 'Unsupported'
			};
		}
...
var author$project$Headless$main = elm$core$Platform$worker(
	{d4: author$project$Headless$initHeadless, ev: author$project$Headless$headlessSubscriptions, eA: author$project$Main$updateWithTime});
