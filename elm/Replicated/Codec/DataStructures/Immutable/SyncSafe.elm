...
import Replicated.Codec.Base as Base exposing (Codec(..), NullCodec, SelfSeededCodec)
...
import Replicated.Codec.CustomType as CustomType exposing (customType, finishCustomType, variant0, variant1, variant2, variant3)
