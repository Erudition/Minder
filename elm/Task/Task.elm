module Task.Task exposing (Change(..), Class, ClassID, ClassSkel, Entry, FullSession, Instance, InstanceID, InstanceSkel, buildRelevantInstanceDict, completed, decodeChange, decodeClass, decodeEntry, decodeInstance, encodeChange, encodeClass, encodeInstance, getFullSessions, getRelevantInstancesFromClass, instanceProgress, makeFullClass, newClassSkel, newInstanceSkel, normalizeTitle, prioritize)
...
makeFullClass : List ParentProperties -> ClassSkel -> Class
...
-}
buildFullClassDict : ( List Entry, IntDict.IntDict ClassSkel ) -> IntDict.IntDict Class
