...
var _evancz$elm_todomvc$Model_TaskMoment$describeMoment = F2(
	function (current, target) {
		var pastOrFuture = A2(_justinmimbs$elm_date_extra$Date_Extra$compare, current, target);
		var delta = A3(_justinmimbs$elm_date_extra$Date_Extra$diff, _justinmimbs$elm_date_extra$Date_Extra$Day, current, target);
		...
		switch (_p0.ctor) {
			...
			case 'GT':
				return 'over due';
			default:
				return (_elm_lang$core$Native_Utils.cmp(delta, 5) > 0) ? 'in less than five hours' : ((_elm_lang$core$Native_Utils.cmp(delta, 5) < 0) ? 'its a 7' : 'idk somewhere sometime somehow');
		}
	});
var _evancz$elm_todomvc$Model_TaskMoment$describeTaskMoment = F2(
	function (now, target) {
		var _p1 = target;
		switch (_p1.ctor) {
			case 'Unset':
...
var _evancz$elm_todomvc$Model_TaskMoment$encodeTaskMoment = function (taskmoment) {
	return _elm_lang$core$Json_Encode$object(
		{ctor: '[]'});
};
var _evancz$elm_todomvc$Model_TaskMoment$encodeMoment = function (moment) {
	return _elm_lang$core$Json_Encode$string(
		_justinmimbs$elm_date_extra$Date_Extra$toIsoString(moment));
};
var _evancz$elm_todomvc$Model_TaskMoment$decodeMoment = _elm_community$json_extra$Json_Decode_Extra$date;
var _evancz$elm_todomvc$Model_TaskMoment$UniversalMoment = function (a) {
	return {ctor: 'UniversalMoment', _0: a};
};
var _evancz$elm_todomvc$Model_TaskMoment$LocalMoment = function (a) {
	return {ctor: 'LocalMoment', _0: a};
};
var _evancz$elm_todomvc$Model_TaskMoment$DateOnly = function (a) {
	return {ctor: 'DateOnly', _0: a};
};
var _evancz$elm_todomvc$Model_TaskMoment$Unset = {ctor: 'Unset'};
var _evancz$elm_todomvc$Model_TaskMoment$decodeTaskMoment = A2(
	...
	'TaskMoment',
	{
		...
		_0: A2(
			...
			'Unset',
			_elm_lang$core$Json_Decode$succeed(_evancz$elm_todomvc$Model_TaskMoment$Unset)),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$elm_todomvc$Porting$valueC,
				'DateOnly',
				A3(_evancz$elm_todomvc$Porting$subValue, _evancz$elm_todomvc$Model_TaskMoment$DateOnly, 'moment', _evancz$elm_todomvc$Model_TaskMoment$decodeMoment)),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$elm_todomvc$Porting$valueC,
					'LocalMoment',
					A3(_evancz$elm_todomvc$Porting$subValue, _evancz$elm_todomvc$Model_TaskMoment$LocalMoment, 'moment', _evancz$elm_todomvc$Model_TaskMoment$decodeMoment)),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$elm_todomvc$Porting$valueC,
						'UniversalMoment',
						A3(_evancz$elm_todomvc$Porting$subValue, _evancz$elm_todomvc$Model_TaskMoment$UniversalMoment, 'moment', _evancz$elm_todomvc$Model_TaskMoment$decodeMoment)),
					_1: {ctor: '[]'}
				}
			}
		}
...
var _evancz$elm_todomvc$Model_Task$newTask = F2(
	function (description, id) {
		return {
			...
			deadline: _evancz$elm_todomvc$Model_TaskMoment$Unset,
			plannedStart: _evancz$elm_todomvc$Model_TaskMoment$Unset,
			plannedFinish: _evancz$elm_todomvc$Model_TaskMoment$Unset,
			relevanceStarts: _evancz$elm_todomvc$Model_TaskMoment$Unset,
			relevanceEnds: _evancz$elm_todomvc$Model_TaskMoment$Unset
		};
	});
										...
										_1: {
											...
											_1: {
												...
												_0: {
													ctor: '_Tuple2',
													_0: 'deadline',
													_1: _evancz$elm_todomvc$Model_TaskMoment$encodeTaskMoment(record.deadline)
												},
												_1: {
													ctor: '::',
													_0: {
														ctor: '_Tuple2',
														_0: 'plannedStart',
														_1: _evancz$elm_todomvc$Model_TaskMoment$encodeTaskMoment(record.plannedStart)
													},
													_1: {
														ctor: '::',
														_0: {
															ctor: '_Tuple2',
															_0: 'plannedFinish',
															_1: _evancz$elm_todomvc$Model_TaskMoment$encodeTaskMoment(record.plannedFinish)
														},
														_1: {
															ctor: '::',
															_0: {
																ctor: '_Tuple2',
																_0: 'relevanceStarts',
																_1: _evancz$elm_todomvc$Model_TaskMoment$encodeTaskMoment(record.relevanceStarts)
															},
															_1: {
																ctor: '::',
																_0: {
																	ctor: '_Tuple2',
																	_0: 'relevanceEnds',
																	_1: _evancz$elm_todomvc$Model_TaskMoment$encodeTaskMoment(record.relevanceEnds)
																},
																_1: {ctor: '[]'}
															}
														}
...
var _evancz$elm_todomvc$Model_Task$decodeTask = A3(
	...
	'relevanceEnds',
	_evancz$elm_todomvc$Model_TaskMoment$decodeTaskMoment,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'relevanceStarts',
		_evancz$elm_todomvc$Model_TaskMoment$decodeTaskMoment,
...
var _evancz$elm_todomvc$Model_Task$DateChange = function (a) {
	return {ctor: 'DateChange', _0: a};
};
	...
	'TaskChange',
	{
		...
		_1: {
			...
			_0: A2(
				_evancz$elm_todomvc$Porting$valueC,
				'Created',
				A3(_evancz$elm_todomvc$Porting$subValue, _evancz$elm_todomvc$Model_Task$Created, 'moment', _evancz$elm_todomvc$Model_TaskMoment$decodeMoment)),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$elm_todomvc$Porting$valueC,
...
var _evancz$elm_todomvc$View$extractDate = F3(
	function (task, field, input) {
		...
		if (_p0.ctor === 'Ok') {
			return A3(
				_evancz$elm_todomvc$Update$UpdateTaskDate,
				task,
				field,
				_evancz$elm_todomvc$Model_TaskMoment$DateOnly(_p0._0));
		} else {
			return _evancz$elm_todomvc$Update$NoOp;
		}
	});
var _evancz$elm_todomvc$View$timingInfo = F2(
	function (time, task) {
		return _rtfeldman$elm_css$Html_Styled$text(
			A2(_evancz$elm_todomvc$Model_TaskMoment$describeTaskMoment, time, task.deadline));
	});
